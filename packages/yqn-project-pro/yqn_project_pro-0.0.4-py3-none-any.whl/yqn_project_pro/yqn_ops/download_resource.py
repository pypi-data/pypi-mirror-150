...
from yqn_project_pro.utils.download_file import download_url_to_file
from yqn_project_pro.log.helper import set_logger
...
def get_args_parser():
    from yqn_project_pro.yqn_ops import __version__
