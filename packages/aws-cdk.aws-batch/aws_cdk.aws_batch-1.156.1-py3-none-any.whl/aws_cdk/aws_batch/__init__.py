...
class CfnComputeEnvironment(
    ...
    def __init__(
        ...
        *,
        ...
        :param replace_compute_environment: ``AWS::Batch::ComputeEnvironment.ReplaceComputeEnvironment``.
        ...
        :param update_policy: ``AWS::Batch::ComputeEnvironment.UpdatePolicy``.
        '''
    ...
    class ComputeResourcesProperty:
        def __init__(
            ...
            *,
            ...
            :param update_to_latest_image_version: ``CfnComputeEnvironment.ComputeResourcesProperty.UpdateToLatestImageVersion``.
    ...
    class UpdatePolicyProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param job_execution_timeout_minutes: ``CfnComputeEnvironment.UpdatePolicyProperty.JobExecutionTimeoutMinutes``.
            :param terminate_jobs_on_update: ``CfnComputeEnvironment.UpdatePolicyProperty.TerminateJobsOnUpdate``.
