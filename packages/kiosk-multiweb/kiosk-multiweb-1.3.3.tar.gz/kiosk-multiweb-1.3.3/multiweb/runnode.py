...
def run_node():
    nodeconfig = prepare_config('multiweb')
    ...
    from .app import KioskMultiWebApplication

    print("Creating Application : {}".format(KioskMultiWebApplication))
    app = KioskMultiWebApplication(config=nodeconfig)
    app.run()
