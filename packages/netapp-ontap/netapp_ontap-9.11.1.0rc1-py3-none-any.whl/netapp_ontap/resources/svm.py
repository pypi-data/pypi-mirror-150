...
Example: 02c9e252-41be-11e9-81d5-00a0986138f7 """
    ...
    """aggregates.links,aggregates.name,aggregates.uuid,anti_ransomware_default_volume_state,certificate.name,certificate.uuid,cifs.allowed,comment,fcp,ip_interfaces,is_space_enforcement_logical,is_space_reporting_logical,iscsi,language,max_volumes,name,ndmp,nfs,nsswitch,nvme,qos_policy.max_throughput_iops,qos_policy.max_throughput_mbps,qos_policy.min_throughput_iops,qos_policy.min_throughput_mbps,qos_policy.name,qos_policy.uuid,snapmirror,snapshot_policy.name,snapshot_policy.uuid,state,"""
...
"""
    ...
    if RECLINE_INSTALLED:
        ...
        def svm_show(
            fields: List[Choices.define(["aggregates_delegated", "anti_ransomware_default_volume_state", "comment", "is_space_enforcement_logical", "is_space_reporting_logical", "language", "max_volumes", "name", "state", "subtype", "uuid", "*"])]=None,
        ) -> ResourceTable:
