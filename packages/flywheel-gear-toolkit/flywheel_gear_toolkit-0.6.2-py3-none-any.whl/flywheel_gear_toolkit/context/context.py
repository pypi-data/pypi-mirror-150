...
class GearToolkitContext:
    ...
    def update_container_metadata(
        self, container_type, *args, deep_merge=True, **kwargs
    ):
        ...
        Args:
            ...
            *args (list): Arbitrary list of dictionaries.
            deep_merge (bool): Whether or not to perform a recursive update for dict
                key (e.g. info) (Default: True).
        ...
        self._update_metadata(container_type, update, deep_merge=deep_merge)
        return update

    def update_file_metadata(self, file_name, *args, deep_merge=True, **kwargs):
        ...
        self._update_metadata(
            container_type, update, file_name=file_name, deep_merge=deep_merge
        )
        return update

    def update_destination_metadata(self, *args, deep_merge=True, **kwargs):
    ...
    def _update_metadata(
        self, container_type, metadata, file_name=None, deep_merge=True
    ):
        ...
        Args:
            ...
            deep_merge (bool): If True, perform a recursive dict update. If False, default
    ...
    def deep_merge(self, base, update):
        ...
        Instead of updating only top-level keys, `deep_merge` recurses down to perform
        a "nested" update.
        """
        for k, v in update.items():
            if (
                ...
                and isinstance(update[k], Mapping)
            ):
                self.deep_merge(base[k], update[k])
            else:
                base[k] = update[k]
