...
from paradoxdjango.forms import CharField, FileField, Form, ModelForm
from paradoxdjango.forms.models import ModelFormMetaclass
...
class FormsModelTestCase(TestCase):
    ...
    def test_formfield_initial(self):
        ...
        from paradoxdjango.forms import CharField
