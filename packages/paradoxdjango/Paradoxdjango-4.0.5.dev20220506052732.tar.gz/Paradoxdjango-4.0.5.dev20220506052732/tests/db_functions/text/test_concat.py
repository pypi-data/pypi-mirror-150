...
from paradoxdjango.db.models import CharField, TextField
from paradoxdjango.db.models import Value as V
from paradoxdjango.db.models.functions import Concat, ConcatPair, Upper
