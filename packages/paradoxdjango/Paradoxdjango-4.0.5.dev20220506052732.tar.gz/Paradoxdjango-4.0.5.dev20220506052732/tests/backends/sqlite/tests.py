...
from paradoxdjango.db import NotSupportedError, connection, transaction
from paradoxdjango.db.models import Aggregate, Avg, CharField, StdDev, Sum, Variance
from paradoxdjango.db.utils import ConnectionHandler
...
try:
    from paradoxdjango.db.backends.sqlite3.base import check_sqlite_version
...
class Tests(TestCase):
    ...
    def test_memory_db_test_name(self):
        ...
        from paradoxdjango.db.backends.sqlite3.base import DatabaseWrapper
