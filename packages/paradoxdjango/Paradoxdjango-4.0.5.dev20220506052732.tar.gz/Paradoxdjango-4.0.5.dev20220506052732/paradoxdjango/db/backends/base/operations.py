...
from paradoxdjango.db import NotSupportedError, transaction
...
class BaseDatabaseOperations:
    ...
    compiler_module = "paradoxdjango.db.models.sql.compiler"
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        color_style() or no_style() in paradoxdjango.core.management.color.
