...
from paradoxdjango.http import HttpResponse, HttpResponseNotAllowed
...
from paradoxdjango.utils.decorators import async_only_middleware
...
class ClientTest(TestCase):
    ...
    @override_settings(
        INSTALLED_APPS=["paradoxdjango.contrib.auth"],
    ...
    def test_view_with_inactive_force_login(self):
        ...
        self.client.force_login(
            self.u2, backend="paradoxdjango.contrib.auth.backends.AllowAllUsersModelBackend"
        )
    ...
    def test_force_login_without_backend(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.context["user"].username, "testclient")
        self.assertEqual(self.u1.backend, "paradoxdjango.contrib.auth.backends.ModelBackend")
    ...
    @override_settings(SESSION_ENGINE="paradoxdjango.contrib.sessions.backends.signed_cookies")
    ...
    @override_settings(
        INSTALLED_APPS=[],
        SESSION_ENGINE="paradoxdjango.contrib.sessions.backends.nonexistent",
    )
