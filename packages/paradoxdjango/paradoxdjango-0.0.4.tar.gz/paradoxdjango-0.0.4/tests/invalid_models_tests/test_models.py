...
from paradoxdjango.db import connection, connections, models
from paradoxdjango.db.models.functions import Abs, Lower, Round
from paradoxdjango.db.models.signals import post_init
from paradoxdjango.test import SimpleTestCase, TestCase, skipUnlessDBFeature
from paradoxdjango.test.utils import isolate_apps, override_settings, register_lookup
...
class OtherModelTests(SimpleTestCase):
    ...
    @isolate_apps("paradoxdjango.contrib.auth", kwarg_name="apps")
