...
from paradoxdjango.core.files.uploadedfile import SimpleUploadedFile
from paradoxdjango.db import DatabaseError, connection
from paradoxdjango.http import Http404, HttpRequest, HttpResponse
from paradoxdjango.shortcuts import render
from paradoxdjango.template import TemplateDoesNotExist
from paradoxdjango.test import RequestFactory, SimpleTestCase, override_settings
from paradoxdjango.test.utils import LoggingCaptureMixin
from paradoxdjango.urls import path, reverse
from paradoxdjango.urls.converters import IntConverter
...
from paradoxdjango.views.debug import (
    CallableSettingWrapper,
    ExceptionCycleWarning,
    ExceptionReporter,
)
from paradoxdjango.views.debug import Path as DebugPath
from paradoxdjango.views.debug import (
...
from paradoxdjango.views.decorators.debug import sensitive_post_parameters, sensitive_variables
...
class DebugViewTests(SimpleTestCase):
    def test_files(self):
        with self.assertLogs("paradoxdjango.request", "ERROR"):
    ...
    def test_400(self):
        ...
        with self.assertLogs("paradoxdjango.security", "WARNING"):
            response = self.client.get("/raises400/")
        self.assertContains(response, '<div class="context" id="', status_code=400)

    def test_400_bad_request(self):
        # When DEBUG=True, technical_500_template() is called.
        with self.assertLogs("paradoxdjango.request", "WARNING") as cm:
        ...
        TEMPLATES=[
            {
                ...
                "OPTIONS": {
                    "loaders": [
                        (
                            "paradoxdjango.template.loaders.locmem.Loader",
                            {
                                "403.html": (
    ...
    def test_template_loader_postmortem(self):
        ...
        with tempfile.NamedTemporaryFile(prefix=template_name) as tmpfile:
            ...
            ), self.assertLogs("paradoxdjango.request", "ERROR"):
                response = self.client.get(
                    reverse(
            ...
            self.assertContains(
                response,
                "<li><code>paradoxdjango.template.loaders.filesystem.Loader</code>: "
...
class ExceptionReporterTests(SimpleTestCase):
    ...
    def test_reporting_frames_source_not_match(self):
        try:
            ...
            exc_type, exc_value, tb = sys.exc_info()
        with mock.patch(
            "paradoxdjango.views.debug.ExceptionReporter._get_source",
