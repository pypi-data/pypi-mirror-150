# RemovedInDjango50
from paradoxdjango.forms import CharField, EmailField, Form, HiddenInput
from paradoxdjango.forms.utils import ErrorList
from paradoxdjango.test import SimpleTestCase, ignore_warnings
...
class DeprecationTests(SimpleTestCase):
    def test_deprecation_warning_html_output(self):
        msg = (
            "paradoxdjango.forms.BaseForm._html_output() is deprecated. Please use "
