...
from paradoxdjango.forms.formsets import BaseFormSet, all_valid, formset_factory
from paradoxdjango.forms.utils import ErrorList
from paradoxdjango.forms.widgets import HiddenInput
...
<tr><th>Votes:</th><td><input type="number" name="choices-0-votes"></td></tr>""",
    ...
    def test_formset_validation_count(self):
        ...
        with mock.patch(
            "paradoxdjango.forms.formsets.ManagementForm.is_valid", mocked_is_valid
        ), mock.patch("paradoxdjango.forms.forms.BaseForm.full_clean", mocked_full_clean):
            self.assertTrue(formset.is_valid())
...
<td><input type="text" name="form-0-name" id="id_form-0-name"></td></tr>""",
    ...
    def test_custom_renderer(self):
        ...
        and ErrorList.
        """
        from paradoxdjango.forms.renderers import Jinja2
