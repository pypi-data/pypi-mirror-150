...
from paradoxdjango.apps.registry import apps as global_apps
from paradoxdjango.db import DatabaseError, connection, migrations, models
from paradoxdjango.db.migrations.exceptions import InvalidMigrationPlan
from paradoxdjango.db.migrations.executor import MigrationExecutor
...
from paradoxdjango.db.migrations.state import ProjectState
...
class ExecutorTests(MigrationTestBase):
    ...
    @override_settings(
        MIGRATION_MODULES={
            ...
            "paradoxdjango.contrib.auth": "paradoxdjango.contrib.auth.migrations",
        },
    ...
    def test_migrations_applied_and_recorded_atomically(self):
        ...
        executor = MigrationExecutor(connection)
        with mock.patch(
            "paradoxdjango.db.migrations.executor.MigrationExecutor.record_migration"
        ) as record_migration:
