"""Tests related to paradoxdjango.db.backends that haven't been organized."""
import datetime
import threading
import unittest
import warnings
...
from paradoxdjango.db.models.sql.constants import CURSOR
...
class BackendTestCase(TransactionTestCase):
    ...
    @mock.patch("paradoxdjango.db.backends.utils.logger")
    @override_settings(DEBUG=True)
...
class ThreadTests(TransactionTestCase):
    ...
    def test_default_connection_thread_local(self):
        """
        The default connection (i.e. paradoxdjango.db.connection) is different for
        each thread (#17258).
        """
        ...
        def runner():
            # Passing paradoxdjango.db.connection between threads doesn't work while
