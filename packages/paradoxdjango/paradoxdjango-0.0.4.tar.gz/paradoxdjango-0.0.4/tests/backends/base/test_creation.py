...
from paradoxdjango.db.backends.base.creation import TEST_DATABASE_PREFIX, BaseDatabaseCreation
from paradoxdjango.test import SimpleTestCase, TransactionTestCase
...
def get_connection_copy():
    # Get a copy of the default connection. (Can't use paradoxdjango.db.connection
...
@mock.patch(
    "paradoxdjango.db.migrations.recorder.MigrationRecorder.has_table", return_value=False
)
@mock.patch("paradoxdjango.db.migrations.executor.MigrationExecutor.migrate")
@mock.patch("paradoxdjango.core.management.commands.migrate.Command.sync_apps")
...
class TestDeserializeDbFromString(TransactionTestCase):
    ...
    def test_self_reference(self):
        ...
        obj_1.save()
        # Serialize objects.
        with mock.patch("paradoxdjango.db.migrations.loader.MigrationLoader") as loader:
