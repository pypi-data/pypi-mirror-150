...
from paradoxdjango.contrib.staticfiles.handlers import ASGIStaticFilesHandler
from paradoxdjango.core.asgi import get_asgi_application
from paradoxdjango.core.signals import request_finished, request_started
...
class ASGITest(SimpleTestCase):
    ...
    @modify_settings(INSTALLED_APPS={"append": "paradoxdjango.contrib.staticfiles"})
    @override_settings(
        STATIC_URL="static/",
