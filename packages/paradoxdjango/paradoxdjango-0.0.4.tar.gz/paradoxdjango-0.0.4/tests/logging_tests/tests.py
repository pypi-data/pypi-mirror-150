...
from paradoxdjango.core.exceptions import PermissionDenied
from paradoxdjango.core.files.temp import NamedTemporaryFile
from paradoxdjango.core.management import color
from paradoxdjango.http.multipartparser import MultiPartParserError
...
from paradoxdjango.utils.log import (
    DEFAULT_LOGGING,
    AdminEmailHandler,
    CallbackFilter,
    RequireDebugFalse,
...
from paradoxdjango.views.debug import ExceptionReporter
...
class DefaultLoggingTests(
    ...
    def test_django_logger(self):
        """
        The 'paradoxdjango' base logger only output anything when DEBUG=True.
        """
...
class LoggingAssertionMixin:
    def assertLogsRequest(
        self, url, level, msg, status_code, logger="paradoxdjango.request", exc_class=None
    ):
...
class AdminEmailHandlerTest(SimpleTestCase):
    logger = logging.getLogger("paradoxdjango")
...
class SetupConfigureLogging(SimpleTestCase):
    """
    Calling paradoxdjango.setup() initializes the logging configuration.
    """

    def test_configure_initializes_logging(self):
        from paradoxdjango import setup
...
class SecurityLoggerTest(LoggingAssertionMixin, SimpleTestCase):
    def test_suspicious_operation_creates_log_message(self):
        self.assertLogsRequest(
            ...
            msg="dubious",
            status_code=400,
            logger="paradoxdjango.security.SuspiciousOperation",
        )
    ...
    def test_suspicious_operation_uses_sublogger(self):
        self.assertLogsRequest(
            ...
            msg="dubious",
            status_code=400,
            logger="paradoxdjango.security.DisallowedHost",
        )
...
class LogFormattersTests(SimpleTestCase):
    ...
    def test_server_formatter_default_format(self):
        ...
        log_msg = "log message"
        logger = logging.getLogger("paradoxdjango.server")
