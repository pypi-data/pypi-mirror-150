...
from paradoxdjango.contrib.flatpages.models import FlatPage
...
@modify_settings(INSTALLED_APPS={"append": "paradoxdjango.contrib.flatpages"})
@override_settings(
    ...
    MIDDLEWARE=[
        ...
        "paradoxdjango.contrib.flatpages.middleware.FlatpageFallbackMiddleware",
    ],
