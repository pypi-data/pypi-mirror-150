...
from paradoxdjango.contrib.staticfiles import storage
from paradoxdjango.contrib.staticfiles.management.commands import collectstatic, runserver
...
class TestRunserver(StaticFilesTestCase):
    @override_settings(MIDDLEWARE=["paradoxdjango.middleware.common.CommonMiddleware"])
    def test_middleware_loaded_only_once(self):
        command = runserver.Command()
        with mock.patch("paradoxdjango.middleware.common.CommonMiddleware") as mocked:
...
class TestConfiguration(StaticFilesTestCase):
    ...
    def test_local_storage_detection_helper(self):
        ...
        try:
            ...
            with self.settings(
                STATICFILES_STORAGE=(
                    "paradoxdjango.contrib.staticfiles.storage.StaticFilesStorage"
                )
            ):
...
class TestCollectionHelpSubcommand(AdminScriptTestCase):
    ...
    def test_missing_settings_dont_prevent_help(self):
        ...
        """
        self.write_settings("settings.py", apps=["paradoxdjango.contrib.staticfiles"])
...
class TestCollectionVerbosity(CollectionTestCase):
    ...
    @override_settings(
        STATICFILES_STORAGE=(
            "paradoxdjango.contrib.staticfiles.storage.ManifestStaticFilesStorage"
        )
    )
...
@override_settings(
    STATICFILES_STORAGE="paradoxdjango.contrib.staticfiles.storage.ManifestStaticFilesStorage"
)
