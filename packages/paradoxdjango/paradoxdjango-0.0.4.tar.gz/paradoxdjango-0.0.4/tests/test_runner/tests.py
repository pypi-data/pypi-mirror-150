"""
Tests for paradoxdjango test runner
"""
...
from paradoxdjango.core.management.base import SystemCheckError
from paradoxdjango.test import SimpleTestCase, TransactionTestCase, skipUnlessDBFeature
from paradoxdjango.test.runner import (
    DiscoverRunner,
    Shuffler,
    reorder_test_bin,
    reorder_tests,
...
from paradoxdjango.test.testcases import connections_support_transactions
...
from paradoxdjango.utils.deprecation import RemovedInDjango50Warning
    ...
    def test_transaction_support(self):
        ...
        for option_key, option_value in (
            ...
            tested_connections = db.ConnectionHandler(
                {
                    "default": {
                        "ENGINE": "paradoxdjango.db.backends.sqlite3",
            ...
            with mock.patch("paradoxdjango.test.utils.connections", new=tested_connections):
...
class SetupDatabasesTests(SimpleTestCase):
    ...
    def test_setup_aliased_databases(self):
        tested_connections = db.ConnectionHandler(
            {
                "default": {
                    "ENGINE": "paradoxdjango.db.backends.dummy",
                    "NAME": "dbname",
                },
                "other": {
                    "ENGINE": "paradoxdjango.db.backends.dummy",
        ...
        with mock.patch(
            "paradoxdjango.db.backends.dummy.base.DatabaseWrapper.creation_class"
    ...
    def test_setup_test_database_aliases(self):
        ...
        with mock.patch("paradoxdjango.test.utils.connections", new=tested_connections):
            ...
            self.assertEqual(
                test_databases,
                {
                    ("", "", "paradoxdjango.db.backends.dummy", "test_dbname"): (
                        "dbname",
                        ["default", "other"],
                    ),
                },
    ...
    def test_destroy_test_db_restores_db_name(self):
        ...
        with mock.patch("paradoxdjango.db.connections", new=tested_connections):
...
class EmptyDefaultDatabaseTest(unittest.TestCase):
    def test_empty_default_database(self):
        ...
        with mock.patch("paradoxdjango.db.connections", new=tested_connections):
            ...
            self.assertEqual(
                connection.settings_dict["ENGINE"], "paradoxdjango.db.backends.dummy"
            )
...
class RunTestsExceptionHandlingTests(unittest.TestCase):
    def test_run_checks_raises(self):
        ...
        """
        with mock.patch(
            "paradoxdjango.test.runner.DiscoverRunner.setup_test_environment"
        ), mock.patch("paradoxdjango.test.runner.DiscoverRunner.setup_databases"), mock.patch(
            "paradoxdjango.test.runner.DiscoverRunner.build_suite"
        ), mock.patch(
            "paradoxdjango.test.runner.DiscoverRunner.run_checks", side_effect=SystemCheckError
        ), mock.patch(
            "paradoxdjango.test.runner.DiscoverRunner.teardown_databases"
        ) as teardown_databases, mock.patch(
            "paradoxdjango.test.runner.DiscoverRunner.teardown_test_environment"
    ...
    def test_run_checks_passes_and_teardown_raises(self):
        ...
        with mock.patch(
            ...
            "paradoxdjango.test.runner.DiscoverRunner.run_checks"
        ), mock.patch(
            "paradoxdjango.test.runner.DiscoverRunner.teardown_databases",
            side_effect=ValueError,
        ) as teardown_databases, mock.patch(
