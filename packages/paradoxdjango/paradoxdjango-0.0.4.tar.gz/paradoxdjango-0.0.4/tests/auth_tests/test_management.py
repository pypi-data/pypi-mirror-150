...
from paradoxdjango.contrib.auth import get_permission_codename, management
from paradoxdjango.contrib.auth.management import create_permissions, get_default_username
from paradoxdjango.contrib.auth.management.commands import changepassword, createsuperuser
...
@override_settings(
    AUTH_PASSWORD_VALIDATORS=[
        {"NAME": "paradoxdjango.contrib.auth.password_validation.NumericPasswordValidator"},
    ]
)
