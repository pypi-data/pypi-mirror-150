...
from paradoxdjango.utils import text
from paradoxdjango.utils.functional import lazystr
from paradoxdjango.utils.text import format_lazy
from paradoxdjango.utils.translation import gettext_lazy, override
...
class TestUtilsText(SimpleTestCase):
    ...
    def test_format_lazy(self):
        self.assertEqual("paradoxdjango/test", format_lazy("{}/{}", "paradoxdjango", lazystr("test")))
        self.assertEqual("paradoxdjango/test", format_lazy("{0}/{1}", *("paradoxdjango", "test")))
        self.assertEqual(
            "paradoxdjango/test", format_lazy("{a}/{b}", **{"a": "paradoxdjango", "b": "test"})
        )
        self.assertEqual(
            "paradoxdjango/test", format_lazy("{a[0]}/{a[1]}", a=("paradoxdjango", "test"))
        )

        t = {}
        s = format_lazy("{0[a]}-{p[a]}", t, p=t)
        t["a"] = lazystr("paradoxdjango")
        self.assertEqual("paradoxdjango-paradoxdjango", s)
        t["a"] = "update"
