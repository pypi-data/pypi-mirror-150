...
from paradoxdjango.utils.lorem_ipsum import paragraph, paragraphs, sentence, words
...
class LoremIpsumTests(unittest.TestCase):
    ...
    @mock.patch("paradoxdjango.utils.lorem_ipsum.random.sample")
    ...
    @mock.patch("paradoxdjango.utils.lorem_ipsum.random.sample")
    @mock.patch("paradoxdjango.utils.lorem_ipsum.random.choice")
    @mock.patch("paradoxdjango.utils.lorem_ipsum.random.randint")
