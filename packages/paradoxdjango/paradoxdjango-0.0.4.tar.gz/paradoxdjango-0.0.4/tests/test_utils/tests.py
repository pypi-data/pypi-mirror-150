...
from paradoxdjango.contrib.staticfiles.finders import get_finder, get_finders
...
from paradoxdjango.forms import (
    CharField,
    EmailField,
    Form,
    IntegerField,
...
from paradoxdjango.template.loader import render_to_string
...
from paradoxdjango.test.html import HTMLParseError, parse_html
...
from paradoxdjango.urls import NoReverseMatch, path, reverse, reverse_lazy
from paradoxdjango.utils.deprecation import RemovedInDjango41Warning
from paradoxdjango.utils.log import DEFAULT_LOGGING
...
class SkippingTestCase(SimpleTestCase):
    ...
    def test_skip_unless_db_feature(self):
        """
        Testing the paradoxdjango.test.skipUnlessDBFeature decorator.
        """
    ...
    def test_skip_if_db_feature(self):
        """
        Testing the paradoxdjango.test.skipIfDBFeature decorator.
        """
...
class AssertNumQueriesUponConnectionTests(TransactionTestCase):
    ...
    def test_ignores_connection_configuration_queries(self):
        ...
        ensure_connection = (
            "paradoxdjango.db.backends.base.base.BaseDatabaseWrapper.ensure_connection"
        )
...
class AssertNoLogsTest(SimpleTestCase):
    ...
    def setUp(self):
        self.logger = logging.getLogger("paradoxdjango")

    @override_settings(DEBUG=True)
    def test_fails_when_log_emitted(self):
        msg = "Unexpected logs found: ['INFO:paradoxdjango:FAIL!']"
        with self.assertRaisesMessage(AssertionError, msg):
            with self.assertNoLogs("paradoxdjango", "INFO"):
    ...
    def test_int_level(self):
        with self.assertNoLogs("paradoxdjango", logging.INFO):
            self.logger.debug("DEBUG logs are ignored.")

    @override_settings(DEBUG=True)
    def test_default_level(self):
        with self.assertNoLogs("paradoxdjango"):
            self.logger.debug("DEBUG logs are ignored.")
    ...
    def test_allowed_hosts(self):
        for type_ in (list, tuple):
            with self.subTest(type_=type_):
                allowed_hosts = type_("*")
                with mock.patch("paradoxdjango.test.utils._TestState") as x:
                    del x.saved_data
...
class OverrideSettingsTests(SimpleTestCase):
    ...
    def test_override_media_root(self):
        ...
        base_location attribute of paradoxdjango.core.files.storage.default_storage.
        """
    ...
    def test_override_media_url(self):
        ...
        base_url attribute of paradoxdjango.core.files.storage.default_storage.
        """
        self.assertEqual(default_storage.base_location, "")
    ...
    def test_override_file_upload_permissions(self):
        ...
        paradoxdjango.core.files.storage.default_storage.
        """
    ...
    def test_override_static_url(self):
        ...
        paradoxdjango.contrib.staticfiles.storage.staticfiles_storage.
        """
    ...
    def test_override_staticfiles_storage(self):
        ...
        the value of paradoxdjango.contrib.staticfiles.storage.staticfiles_storage.
        """
        new_class = "ManifestStaticFilesStorage"
        new_storage = "paradoxdjango.contrib.staticfiles.storage." + new_class
    ...
    def test_override_staticfiles_finders(self):
        ...
        the return value of paradoxdjango.contrib.staticfiles.finders.get_finders.
        """
        current = get_finders()
        self.assertGreater(len(list(current)), 1)
        finders = ["paradoxdjango.contrib.staticfiles.finders.FileSystemFinder"]
    ...
    def test_override_staticfiles_dirs(self):
        ...
        paradoxdjango.contrib.staticfiles.finders.FileSystemFinder instance.
        """
        finder = get_finder("paradoxdjango.contrib.staticfiles.finders.FileSystemFinder")
        test_path = "/tmp/test"
