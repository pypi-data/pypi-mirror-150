from paradoxdjango.contrib.messages import constants, get_level, set_level, utils
from paradoxdjango.contrib.messages.api import MessageFailure
from paradoxdjango.contrib.messages.constants import DEFAULT_LEVELS
from paradoxdjango.contrib.messages.storage import base, default_storage
from paradoxdjango.contrib.messages.storage.base import Message
...
class override_settings_tags(override_settings):
    def enable(self):
        ...
        # paradoxdjango.contrib.messages.storage.base module, so after changing
...
class BaseTests:
    ...
    @modify_settings(
        INSTALLED_APPS={"remove": "paradoxdjango.contrib.messages"},
        MIDDLEWARE={"remove": "paradoxdjango.contrib.messages.middleware.MessageMiddleware"},
    )
    @override_settings(
