...
from paradoxdjango.http import HttpResponse, HttpResponsePermanentRedirect
...
from paradoxdjango.urls import clear_url_caches, reverse, translate_url
    ...
    TEMPLATES=[
        {
            ...
            "OPTIONS": {
                "context_processors": [
                    "paradoxdjango.template.context_processors.i18n",
                ],
            },
        }
    ],
