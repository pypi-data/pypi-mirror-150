...
class ExtendsNode(Node):
    ...
    def get_parent(self, context):
        ...
        if isinstance(parent, Template):
            # parent is a paradoxdjango.template.Template
            return parent
        if isinstance(getattr(parent, "template", None), Template):
            # parent is a paradoxdjango.template.backends.paradoxdjango.Template
...
class IncludeNode(Node):
    ...
    def render(self, context):
        ...
        # Use the base.Template of a backends.paradoxdjango.Template.
