...
from paradoxdjango.core.serializers import base
from paradoxdjango.db import DEFAULT_DB_ALIAS, models
from paradoxdjango.utils.xmlutils import SimplerXMLGenerator, UnserializableContentError
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("paradoxdjango-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("paradoxdjango-objects")
