from paradoxdjango.contrib.syndication.views import Feed as BaseFeed
from paradoxdjango.utils.feedgenerator import Atom1Feed, Rss201rev2Feed
...
class Feed(BaseFeed):
    """
    This is a subclass of the `Feed` from `paradoxdjango.contrib.syndication`.
