from paradoxdjango.contrib.gis.db.backends.base.features import BaseSpatialFeatures
from paradoxdjango.db.backends.mysql.features import DatabaseFeatures as MySQLDatabaseFeatures
