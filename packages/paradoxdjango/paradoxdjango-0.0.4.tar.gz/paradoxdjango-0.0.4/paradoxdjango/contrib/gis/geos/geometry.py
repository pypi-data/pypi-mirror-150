...
from paradoxdjango.contrib.gis.geos import prototypes as capi
from paradoxdjango.contrib.gis.geos.base import GEOSBase
from paradoxdjango.contrib.gis.geos.coordseq import GEOSCoordSeq
from paradoxdjango.contrib.gis.geos.error import GEOSException
from paradoxdjango.contrib.gis.geos.libgeos import GEOM_PTR
from paradoxdjango.contrib.gis.geos.mutable_list import ListMixin
from paradoxdjango.contrib.gis.geos.prepared import PreparedGeometry
from paradoxdjango.contrib.gis.geos.prototypes.io import ewkb_w, wkb_r, wkb_w, wkt_r, wkt_w
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of paradoxdjango.utils.tree;
