...
from paradoxdjango.contrib.gis.geos.libgeos import (
    GEOM_PTR,
    GEOSFuncFactory,
    geos_version_tuple,
)
from paradoxdjango.contrib.gis.geos.prototypes.errcheck import (
    check_geom,
    check_sized_string,
    check_string,
)
from paradoxdjango.contrib.gis.geos.prototypes.geom import c_uchar_p, geos_char_p
...
class WKBWriter(IOBase):
    ...
    def write(self, geom):
        ...
        from paradoxdjango.contrib.gis.geos import Polygon
    ...
    def write_hex(self, geom):
        ...
        from paradoxdjango.contrib.gis.geos.polygon import Polygon
