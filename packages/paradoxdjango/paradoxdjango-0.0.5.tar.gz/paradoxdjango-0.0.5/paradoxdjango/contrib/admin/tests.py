...
from paradoxdjango.contrib.staticfiles.testing import StaticLiveServerTestCase
from paradoxdjango.test import modify_settings
...
@modify_settings(MIDDLEWARE={"append": "paradoxdjango.contrib.admin.tests.CSPMiddleware"})
