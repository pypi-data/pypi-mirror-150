...
from paradoxdjango.test.utils import NullTimeKeeper, TimeKeeper, iter_test_cases
from paradoxdjango.test.utils import setup_databases as _setup_databases
from paradoxdjango.test.utils import setup_test_environment
from paradoxdjango.test.utils import teardown_databases as _teardown_databases
from paradoxdjango.test.utils import teardown_test_environment
...
class DebugSQLTextTestResult(unittest.TextTestResult):
    def __init__(self, stream, descriptions, verbosity):
        self.logger = logging.getLogger("paradoxdjango.db.backends")
...
def _init_worker(counter):
    ...
    for alias in connections:
        ...
        # reflected in paradoxdjango.db.connections. If the following line assigned
...
def find_top_level(top_level):
    ...
    while True:
        ...
        if try_next == top_level:
            # manage.py-tpl all the way down? give up.
            break
        top_level = try_next
    return top_level
