...
from paradoxdjango.core import signals, signing
from paradoxdjango.core.exceptions import DisallowedRedirect
from paradoxdjango.core.serializers.json import DjangoJSONEncoder
from paradoxdjango.http.cookie import SimpleCookie
...
class JsonResponse(HttpResponse):
    ...
    :param encoder: Should be a json encoder class. Defaults to
      ``paradoxdjango.core.serializers.json.DjangoJSONEncoder``.
