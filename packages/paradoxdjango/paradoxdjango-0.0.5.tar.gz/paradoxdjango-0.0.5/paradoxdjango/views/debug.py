...
from paradoxdjango.http import Http404, HttpResponse, HttpResponseNotFound
from paradoxdjango.template import Context, Engine, TemplateDoesNotExist
from paradoxdjango.template.defaultfilters import pprint
    ...
    def get_exception_traceback_frames(self, exc_value, tb):
        ...
        while tb is not None:
            ...
            yield {
                ...
                "exc_cause_explicit": exc_cause_explicit,
                "tb": tb,
                "type": "paradoxdjango" if module_name.startswith("paradoxdjango.") else "user",
                "filename": filename,
                "function": function,
                "lineno": lineno + 1,
