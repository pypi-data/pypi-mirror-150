...
class MigrationQuestioner:
    ...
    def ask_initial(self, app_label):
        ...
        # without any Python files in it, apart from manage.py-tpl.
        ...
        try:
            ...
            return not any(x.endswith(".py") for x in filenames if x != "manage.py-tpl")
...
class InteractiveMigrationQuestioner(MigrationQuestioner):
    ...
    def _ask_default(self, default=""):
        ...
        print(
            "The datetime and paradoxdjango.utils.timezone modules are available, so "
