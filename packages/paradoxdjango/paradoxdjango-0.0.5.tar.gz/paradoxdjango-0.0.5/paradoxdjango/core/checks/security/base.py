...
SECRET_KEY_INSECURE_PREFIX = "paradoxdjango-insecure-"
SECRET_KEY_MIN_LENGTH = 50
SECRET_KEY_MIN_UNIQUE_CHARACTERS = 5

W001 = Warning(
    "You do not have 'paradoxdjango.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'paradoxdjango.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "paradoxdjango.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "paradoxdjango.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )
