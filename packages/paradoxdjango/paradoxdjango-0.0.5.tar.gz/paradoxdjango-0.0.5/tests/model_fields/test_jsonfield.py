...
from paradoxdjango.db.models.fields.json import (
    KeyTextTransform,
    KeyTransform,
    KeyTransformFactory,
    KeyTransformTextLookupMixin,
)
from paradoxdjango.db.models.functions import Cast
from paradoxdjango.test import SimpleTestCase, TestCase, skipIfDBFeature, skipUnlessDBFeature
...
class TestMethods(SimpleTestCase):
    def test_deconstruct(self):
        ...
        self.assertEqual(path, "paradoxdjango.db.models.JSONField")
...
class TestSerialization(SimpleTestCase):
    ...
    def test_xml_serialization(self):
        test_xml_data = (
            '<paradoxdjango-objects version="1.0">'
            '<object model="model_fields.nullablejsonmodel">'
            '<field name="value" type="JSONField">%s'
            "</field></object></paradoxdjango-objects>"
        )
        for value, serialized in self.test_values:
            with self.subTest(value=value):
