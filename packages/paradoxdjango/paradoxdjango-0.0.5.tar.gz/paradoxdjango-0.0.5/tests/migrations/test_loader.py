...
from paradoxdjango.db.migrations.exceptions import (
    AmbiguityError,
...
class LoaderTests(TestCase):
    ...
    def test_load_empty_dir(self):
        with override_settings(
            ...
            self.assertIn(
                "migrations",
                loader.unmigrated_apps,
                "App missing manage.py-tpl in migrations module not in unmigrated apps.",
            )
    ...
    def test_loading_namespace_package(self):
        """Migration directories without an manage.py-tpl file are ignored."""
        loader = MigrationLoader(connection)
        loader.load_disk()
        migrations = [
            name for app, name in loader.disk_migrations if app == "migrations"
