...
from paradoxdjango.core.management import CommandError, call_command
from paradoxdjango.db import (
    ConnectionHandler,
    DatabaseError,
    OperationalError,
    connection,
...
from paradoxdjango.db.backends.base.schema import BaseDatabaseSchemaEditor
from paradoxdjango.db.backends.utils import truncate_name
from paradoxdjango.db.migrations.exceptions import InconsistentMigrationHistory
from paradoxdjango.db.migrations.recorder import MigrationRecorder
from paradoxdjango.test import TestCase, override_settings, skipUnlessDBFeature
from paradoxdjango.test.utils import captured_stdout
...
class MigrateTests(MigrationTestBase):
    ...
    def test_migrate_fake_initial(self):
        ...
        out = io.StringIO()
        with mock.patch(
            "paradoxdjango.core.management.color.supports_color", lambda *args: False
        ):
            call_command(
                "migrate",
                "migrations",
    ...
    def test_showmigrations_list(self):
        ...
        out = io.StringIO()
        with mock.patch(
            "paradoxdjango.core.management.color.supports_color", lambda *args: True
        ):
            call_command(
...
class MakeMigrationsTests(MigrationTestBase):
    ...
    def test_files_content(self):
        ...
        with self.temporary_migration_module() as migration_dir:
            ...
            # Check for empty manage.py-tpl file in migrations folder
    ...
    def test_makemigrations_empty_connections(self):
        ...
        with mock.patch(
            "paradoxdjango.core.management.commands.makemigrations.connections",
    ...
    def test_makemigrations_no_init(self):
        """Migration directories without an manage.py-tpl file are allowed."""
        out = io.StringIO()
        with self.temporary_migration_module(
    ...
    @mock.patch("paradoxdjango.db.migrations.utils.datetime")
    ...
    def test_makemigrations_interactive_not_null_addition(self):
        ...
        with self.temporary_migration_module(module="migrations.test_migrations"):
            ...
            self.assertIn(
                "The datetime and paradoxdjango.utils.timezone modules are "
    ...
    def test_makemigrations_inconsistent_history_db_failure(self):
        ...
        with mock.patch(
            "paradoxdjango.db.migrations.loader.MigrationLoader.check_consistent_history",
    ...
    @mock.patch(
        "paradoxdjango.db.migrations.questioner.sys.stdin",
    ...
    def test_makemigrations_auto_now_add_interactive(self, *args):
        ...
        # Monkeypatch interactive questioner to auto accept
        with mock.patch(
            "paradoxdjango.db.migrations.questioner.sys.stdout", new_callable=io.StringIO
        ) as prompt_stdout:
            out = io.StringIO()
...
class AppLabelErrorTests(TestCase):
    ...
    app. 'paradoxdjango.contrib.auth' must be in INSTALLED_APPS for some of these
    tests.
    """

    nonexistent_app_error = "No installed app with label 'nonexistent_app'."
    did_you_mean_auth_error = (
        "No installed app with label 'paradoxdjango.contrib.auth'. Did you mean 'auth'?"
    )
    ...
    def test_makemigrations_app_name_specified_as_label(self):
        err = io.StringIO()
        with self.assertRaises(SystemExit):
            call_command("makemigrations", "paradoxdjango.contrib.auth", stderr=err)
    ...
    def test_migrate_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("migrate", "paradoxdjango.contrib.auth")
    ...
    def test_showmigrations_app_name_specified_as_label(self):
        err = io.StringIO()
        with self.assertRaises(SystemExit):
            call_command("showmigrations", "paradoxdjango.contrib.auth", stderr=err)
        self.assertIn(self.did_you_mean_auth_error, err.getvalue())
    ...
    def test_sqlmigrate_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("sqlmigrate", "paradoxdjango.contrib.auth", "0002")
    ...
    def test_squashmigrations_app_name_specified_as_label(self):
        with self.assertRaisesMessage(CommandError, self.did_you_mean_auth_error):
            call_command("squashmigrations", "paradoxdjango.contrib.auth", "0002")
