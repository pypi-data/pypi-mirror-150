...
from paradoxdjango.test.selenium import SeleniumTestCase
from paradoxdjango.urls import reverse
from paradoxdjango.utils.translation import get_language, override
from paradoxdjango.views.i18n import JavaScriptCatalog, get_formats
...
class SetLanguageTests(TestCase):
    """Test the paradoxdjango.views.i18n.set_language view."""
    ...
    def test_setlang_cookie(self):
        ...
        test_settings = {
            "MIDDLEWARE": ["paradoxdjango.middleware.common.CommonMiddleware"],
    ...
    @modify_settings(
        MIDDLEWARE={
            "append": "paradoxdjango.middleware.locale.LocaleMiddleware",
        }
    )
...
class I18NViewTests(SimpleTestCase):
    """Test paradoxdjango.views.i18n views other than set_language."""
