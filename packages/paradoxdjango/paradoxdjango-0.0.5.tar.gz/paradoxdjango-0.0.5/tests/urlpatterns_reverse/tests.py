...
from paradoxdjango.http import HttpRequest, HttpResponsePermanentRedirect, HttpResponseRedirect
from paradoxdjango.shortcuts import redirect
from paradoxdjango.test import RequestFactory, SimpleTestCase, TestCase, override_settings
from paradoxdjango.test.utils import override_script_prefix
from paradoxdjango.urls import (
    NoReverseMatch,
    Resolver404,
    ResolverMatch,
    URLPattern,
...
from paradoxdjango.urls.resolvers import RegexPattern
...
class ViewLoadingTests(SimpleTestCase):
    ...
    def test_attributeerror_not_hidden(self):
        msg = "I am here to confuse paradoxdjango.urls.get_callable"
