...
class TestDefaultPK(SimpleTestCase):
    @override_settings(DEFAULT_AUTO_FIELD="paradoxdjango.db.models.NonexistentAutoField")
    def test_default_auto_field_setting_nonexistent(self):
        msg = (
            "DEFAULT_AUTO_FIELD refers to the module "
            "'paradoxdjango.db.models.NonexistentAutoField' that could not be "
            "imported."
        )
    ...
    def test_app_default_auto_field_nonexistent(self):
        msg = (
            ...
            "refers to the module 'paradoxdjango.db.models.NonexistentAutoField' "
    ...
    @override_settings(DEFAULT_AUTO_FIELD="paradoxdjango.db.models.TextField")
    def test_default_auto_field_setting_non_auto(self):
        msg = (
            "Primary key 'paradoxdjango.db.models.TextField' referred by "
    ...
    @override_settings(DEFAULT_AUTO_FIELD="paradoxdjango.db.models.SmallAutoField")
