...
from paradoxdjango.db import DEFAULT_DB_ALIAS, DatabaseError, connection, connections
from paradoxdjango.db.backends.base.base import BaseDatabaseWrapper
...
class Tests(TestCase):
    ...
    def test_nodb_cursor(self):
        ...
        with self.assertWarnsMessage(RuntimeWarning, msg):
            with mock.patch(
                "paradoxdjango.db.backends.base.base.BaseDatabaseWrapper.connect",
    ...
    def test_nodb_cursor_raises_postgres_authentication_failure(self):
        ...
        with self.assertWarnsMessage(RuntimeWarning, msg):
            mocker_connections_all = mock.patch(
                "paradoxdjango.utils.connection.BaseConnectionHandler.all",
    ...
    def test_database_name_too_long(self):
        from paradoxdjango.db.backends.postgresql.base import DatabaseWrapper
    ...
    def test_connect_isolation_level(self):
        ...
        # Since this is a paradoxdjango.test.TestCase, a transaction is in progress
    ...
    def test_correct_extraction_psycopg2_version(self):
        from paradoxdjango.db.backends.postgresql.base import psycopg2_version
