...
from paradoxdjango.core.management.commands.makemessages import Command as MakeMessagesCommand
from paradoxdjango.core.management.commands.makemessages import write_pot_file
from paradoxdjango.core.management.utils import find_command
from paradoxdjango.test import SimpleTestCase, override_settings
from paradoxdjango.test.utils import captured_stderr, captured_stdout
from paradoxdjango.utils._os import symlinks_supported
from paradoxdjango.utils.translation import TranslatorCommentWarning
...
class ExtractorTests(POFileAssertionMixin, RunInTmpDirMixin, SimpleTestCase):
    ...
    PO_FILE = "locale/%s/LC_MESSAGES/paradoxdjango.po" % LOCALE
    ...
    def assertLocationCommentPresent(self, po_filename, line_number, *comment_parts):
        r"""
        self.assertLocationCommentPresent('paradoxdjango.po', 42, 'dirA', 'dirB', 'foo.py')

        verifies that the paradoxdjango.po file has a gettext-style location comment
        of the form
...
class BasicExtractorTests(ExtractorTests):
    ...
    def test_no_option(self):
        ...
        with mock.patch(
            "paradoxdjango.core.management.commands.makemessages.sys.argv",
    ...
    def test_invalid_locale(self):
        ...
        self.assertIs(Path("locale/pl-PL/LC_MESSAGES/paradoxdjango.po").exists(), False)
    ...
    @mock.patch("paradoxdjango.core.management.commands.makemessages.popen_wrapper")
    ...
    def test_po_file_encoding_when_updating(self):
        ...
        (#23271).
        """
        BR_PO_BASE = "locale/pt_BR/LC_MESSAGES/paradoxdjango"
...
class CopyPluralFormsExtractorTests(ExtractorTests):
    ...
    PO_FILE_ES = "locale/es/LC_MESSAGES/paradoxdjango.po"
    ...
    def test_translate_and_plural_blocktranslate_collision(self):
        ...
        with open(self.PO_FILE) as fp:
            po_contents = fp.read()
            self.assertNotIn(
                "#-#-#-#-#  paradoxdjango.pot (PACKAGE VERSION)  #-#-#-#-#\\n", po_contents
            )
            self.assertMsgId(
...
class LocationCommentsTests(ExtractorTests):
    ...
    @mock.patch(
        "paradoxdjango.core.management.commands.makemessages.Command.gettext_version",
        new=(0, 18, 99),
    )
...
class KeepPotFileExtractorTests(ExtractorTests):
    ...
    POT_FILE = "locale/paradoxdjango.pot"
...
class MultipleLocaleExtractionTests(ExtractorTests):
    PO_FILE_PT = "locale/pt/LC_MESSAGES/paradoxdjango.po"
    PO_FILE_DE = "locale/de/LC_MESSAGES/paradoxdjango.po"
    PO_FILE_KO = "locale/ko/LC_MESSAGES/paradoxdjango.po"
    LOCALES = ["pt", "de", "ch"]
    ...
    def test_all_locales(self):
        ...
        self.assertFalse(os.path.exists("locale/_do_not_pick/LC_MESSAGES/paradoxdjango.po"))
...
class ExcludedLocaleExtractionTests(ExtractorTests):
    ...
    LOCALES = ["en", "fr", "it"]
    PO_FILE = "locale/%s/LC_MESSAGES/paradoxdjango.po"
    ...
    def test_command_help(self):
        with captured_stdout(), captured_stderr():
            ...
            execute_from_command_line(["paradoxdjango-admin", "help", "makemessages"])
...
class CustomLayoutExtractionTests(ExtractorTests):
    ...
    def test_no_locale_raises(self):
        msg = (
            ...
            "manage.py-tpl. Make sure the 'locale' directory exists in an app "
        ...
        * translations outside of that app are in LOCALE_PATHS[0]
        ...
        with override_settings(LOCALE_PATHS=[locale_path]):
            ...
            project_de_locale = os.path.join(
                self.test_dir, "project_locale", "de", "LC_MESSAGES", "paradoxdjango.po"
            )
