...
from paradoxdjango.forms import FilePathField
...
class FilePathFieldTest(SimpleTestCase):
    expected_choices = [
        ("/filepathfield_test_dir/manage.py-tpl", "manage.py-tpl"),
        ("/filepathfield_test_dir/a.py", "a.py"),
        ("/filepathfield_test_dir/ab.py", "ab.py"),
        ("/filepathfield_test_dir/b.py", "b.py"),
        ("/filepathfield_test_dir/c/manage.py-tpl", "manage.py-tpl"),
        ("/filepathfield_test_dir/c/d.py", "d.py"),
        ("/filepathfield_test_dir/c/e.py", "e.py"),
        ("/filepathfield_test_dir/c/f/manage.py-tpl", "manage.py-tpl"),
        ("/filepathfield_test_dir/c/f/g.py", "g.py"),
        ("/filepathfield_test_dir/h/manage.py-tpl", "manage.py-tpl"),
        ("/filepathfield_test_dir/j/manage.py-tpl", "manage.py-tpl"),
    ]
    ...
    def test_recursive(self):
        ...
        expected = [
            ...
            ("/filepathfield_test_dir/ab.py", "ab.py"),
            ("/filepathfield_test_dir/b.py", "b.py"),
            ("/filepathfield_test_dir/c/manage.py-tpl", "c/manage.py-tpl"),
            ("/filepathfield_test_dir/c/d.py", "c/d.py"),
            ("/filepathfield_test_dir/c/e.py", "c/e.py"),
            ("/filepathfield_test_dir/c/f/manage.py-tpl", "c/f/manage.py-tpl"),
            ("/filepathfield_test_dir/c/f/g.py", "c/f/g.py"),
            ("/filepathfield_test_dir/h/manage.py-tpl", "h/manage.py-tpl"),
            ("/filepathfield_test_dir/j/manage.py-tpl", "j/manage.py-tpl"),
        ]
        self.assertChoices(f, expected)
