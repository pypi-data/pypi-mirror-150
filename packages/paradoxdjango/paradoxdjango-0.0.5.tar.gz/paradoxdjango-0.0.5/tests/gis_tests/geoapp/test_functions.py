...
from paradoxdjango.contrib.gis.db.models import GeometryField, PolygonField, functions
from paradoxdjango.contrib.gis.geos import GEOSGeometry, LineString, Point, Polygon, fromstr
from paradoxdjango.contrib.gis.measure import Area
from paradoxdjango.db import NotSupportedError, connection
from paradoxdjango.db.models import IntegerField, Sum, Value
from paradoxdjango.test import TestCase, skipUnlessDBFeature
...
class GISFunctionsTests(FuncTestMixin, TestCase):
    """
    Testing functions from paradoxdjango/contrib/gis/db/models/functions.py.
