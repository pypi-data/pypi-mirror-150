...
from paradoxdjango.conf import (
...
from paradoxdjango.urls import clear_script_prefix, set_script_prefix
...
class SettingsTests(SimpleTestCase):
    ...
    @requires_tz_support
    @mock.patch("paradoxdjango.conf.global_settings.TIME_ZONE", "test")
