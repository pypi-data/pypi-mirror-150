from paradoxdjango.contrib.auth import views as auth_views
from paradoxdjango.contrib.auth.decorators import login_required
from paradoxdjango.urls import path, re_path
from paradoxdjango.views.decorators.cache import cache_page
from paradoxdjango.views.generic import TemplateView, dates
