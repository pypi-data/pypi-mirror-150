...
# It has to be run inside the paradoxdjango git root directory.
#
...
def _get_locale_dirs(resources, include_core=True):
    ...
    optionally including the paradoxdjango core catalog.
    If resources list is not None, filter directories matching resources content.
    """
    contrib_dir = os.path.join(os.getcwd(), "paradoxdjango", "contrib")
    dirs = []
    ...
    if include_core:
        dirs.insert(0, ("core", os.path.join(os.getcwd(), "paradoxdjango", "conf", "locale")))
...
def _tx_resource_for_name(name):
    ...
    if name == "core":
        return "paradoxdjango.core"
    else:
        return "paradoxdjango.contrib-%s" % name
...
def _check_diff(cat_name, base_path):
    ...
    """
    po_path = "%(path)s/en/LC_MESSAGES/paradoxdjango%(ext)s.po" % {
        "path": base_path,
...
def update_catalogs(resources=None, languages=None):
    """
    Update the en/LC_MESSAGES/paradoxdjango.po (main and contrib) files with
    ...
    os.chdir(os.path.join(os.getcwd(), "paradoxdjango"))
...
def lang_stats(resources=None, languages=None):
    ...
    for name, dir_ in locale_dirs:
        ...
        for lang in langs:
            ...
            po_path = "{path}/{lang}/LC_MESSAGES/paradoxdjango{ext}.po".format(
...
def fetch(resources=None, languages=None):
    ...
    for name, dir_ in locale_dirs:
        ...
        for lang in target_langs:
            po_path = "%(path)s/%(lang)s/LC_MESSAGES/paradoxdjango%(ext)s.po" % {
                "path": dir_,
                "lang": lang,
