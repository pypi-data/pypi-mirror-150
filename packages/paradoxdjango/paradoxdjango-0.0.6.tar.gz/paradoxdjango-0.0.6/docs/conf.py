...
try:
    from paradoxdjango import VERSION, get_version
except ImportError:
    release = version
else:
...
modindex_common_prefix = ["paradoxdjango."]

# Appended to every page
rst_epilog = """
.. |paradoxdjango-users| replace:: :ref:`paradoxdjango-users <paradoxdjango-users-mailing-list>`
.. |paradoxdjango-developers| replace:: :ref:`paradoxdjango-developers <paradoxdjango-developers-mailing-list>`
.. |paradoxdjango-announce| replace:: :ref:`paradoxdjango-announce <paradoxdjango-announce-mailing-list>`
.. |paradoxdjango-updates| replace:: :ref:`paradoxdjango-updates <paradoxdjango-updates-mailing-list>`
"""  # NOQA
