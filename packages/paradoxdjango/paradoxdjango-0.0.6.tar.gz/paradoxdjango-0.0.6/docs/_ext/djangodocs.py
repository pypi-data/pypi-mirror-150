...
def setup(app):
    ...
    app.add_object_type(
        directivename="paradoxdjango-admin",
        rolename="djadmin",
        indextemplate="pair: %s; paradoxdjango-admin command",
        parse_node=parse_django_admin_node,
    )
    app.add_directive("paradoxdjango-admin-option", Cmdoption)
...
def parse_django_admin_node(env, sig, signode):
    ...
    title = "paradoxdjango-admin %s" % sig
