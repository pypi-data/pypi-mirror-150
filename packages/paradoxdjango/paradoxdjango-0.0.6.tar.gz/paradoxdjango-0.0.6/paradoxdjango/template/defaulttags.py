...
from paradoxdjango.utils.html import conditional_escape, escape, format_html
from paradoxdjango.utils.lorem_ipsum import paragraphs, words
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from paradoxdjango.utils.html import strip_spaces_between_tags
...
def load(parser, token):
    ...
    ``paradoxdjango/templatetags/news/photos.py``::
