...
def ogrinspect(*args, **kwargs):
    ...
    >>> from paradoxdjango.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from paradoxdjango.contrib.gis.db import models` code from the
...
def _ogrinspect(
    ...
    if imports:
        ...
        yield "from paradoxdjango.contrib.gis.db import models"
        yield ""
        yield ""
