...
from paradoxdjango.contrib.sessions.backends.base import (
    VALID_KEY_CHARS,
    CreateError,
    SessionBase,
    UpdateError,
)
from paradoxdjango.contrib.sessions.exceptions import InvalidSessionKey
from paradoxdjango.core.exceptions import ImproperlyConfigured, SuspiciousOperation
                ...
                try:
                    ...
                    if isinstance(e, SuspiciousOperation):
                        logger = logging.getLogger(
                            "paradoxdjango.security.%s" % e.__class__.__name__
                        )
