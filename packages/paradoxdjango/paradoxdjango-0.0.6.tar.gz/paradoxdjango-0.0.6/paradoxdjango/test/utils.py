...
from paradoxdjango.conf import UserSettingsHolder, settings
from paradoxdjango.core import mail
from paradoxdjango.core.exceptions import ImproperlyConfigured
from paradoxdjango.core.signals import request_started
from paradoxdjango.db import DEFAULT_DB_ALIAS, connections, reset_queries
from paradoxdjango.db.models.options import Options
from paradoxdjango.template import Template
from paradoxdjango.test.signals import setting_changed, template_rendered
from paradoxdjango.urls import get_script_prefix, set_script_prefix
from paradoxdjango.utils.deprecation import RemovedInDjango50Warning
from paradoxdjango.utils.translation import deactivate
...
def setup_test_environment(debug=None):
    ...
    settings.EMAIL_BACKEND = "paradoxdjango.core.mail.backends.locmem.EmailBackend"
...
class override_system_checks(TestContextDecorator):
    ...
    def __init__(self, new_checks, deployment_checks=None):
        from paradoxdjango.core.checks.registry import registry
...
def require_jinja2(test_func):
    ...
    return override_settings(
        TEMPLATES=[
            ...
            {
                "BACKEND": "paradoxdjango.template.backends.jinja2.Jinja2",
                "APP_DIRS": True,
...
class LoggingCaptureMixin:
    """
    Capture the output from the 'paradoxdjango' logger and store it on the class's
