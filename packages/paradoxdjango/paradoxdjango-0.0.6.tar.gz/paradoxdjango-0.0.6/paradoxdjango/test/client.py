...
from paradoxdjango.core.handlers.asgi import ASGIRequest
from paradoxdjango.core.handlers.base import BaseHandler
from paradoxdjango.core.handlers.wsgi import WSGIRequest
from paradoxdjango.core.serializers.json import DjangoJSONEncoder
from paradoxdjango.core.signals import got_request_exception, request_finished, request_started
from paradoxdjango.db import close_old_connections
from paradoxdjango.http import HttpRequest, QueryDict, SimpleCookie
from paradoxdjango.test import signals
from paradoxdjango.test.utils import ContextList
from paradoxdjango.urls import resolve
from paradoxdjango.utils.encoding import force_bytes
...
class ClientMixin:
    ...
    def login(self, **credentials):
        ...
        are incorrect.
        """
        from paradoxdjango.contrib.auth import authenticate
    ...
    def force_login(self, user, backend=None):
        def get_backend():
            from paradoxdjango.contrib.auth import load_backend
    ...
    def _login(self, user, backend=None):
        from paradoxdjango.contrib.auth import login
    ...
    def logout(self):
        ...
        from paradoxdjango.contrib.auth import get_user, logout
