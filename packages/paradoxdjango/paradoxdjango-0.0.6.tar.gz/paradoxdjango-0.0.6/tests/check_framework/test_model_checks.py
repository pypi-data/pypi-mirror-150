...
def mocked_is_overridden(self, setting):
    # Force treating DEFAULT_AUTO_FIELD = 'paradoxdjango.db.models.AutoField' as a not
    # overridden setting.
    return (
        setting != "DEFAULT_AUTO_FIELD"
        or self.DEFAULT_AUTO_FIELD != "paradoxdjango.db.models.AutoField"
    )


@mock.patch("paradoxdjango.conf.UserSettingsHolder.is_overridden", mocked_is_overridden)
@override_settings(DEFAULT_AUTO_FIELD="paradoxdjango.db.models.AutoField")
@isolate_apps("check_framework.apps.CheckDefaultPKConfig", attr_name="apps")
@override_system_checks([checks.model_checks.check_all_models])
class ModelDefaultAutoFieldTests(SimpleTestCase):
    msg = (
        "Auto-created primary key used when not defining a primary key type, "
        "by default 'paradoxdjango.db.models.AutoField'."
    )
    hint = (
        "Configure the DEFAULT_AUTO_FIELD setting or the "
        "CheckDefaultPKConfig.default_auto_field attribute to point to a "
        "subclass of AutoField, e.g. 'paradoxdjango.db.models.BigAutoField'."
    )
    ...
    @override_settings(DEFAULT_AUTO_FIELD="paradoxdjango.db.models.BigAutoField")
