...
class ContentTypesViewsSiteRelTests(TestCase):
    ...
    @mock.patch("paradoxdjango.apps.apps.get_model")
...
class ShortcutViewTests(TestCase):
    ...
    def test_not_dependent_on_sites_app(self):
        ...
        with self.modify_settings(INSTALLED_APPS={"append": "paradoxdjango.contrib.sites"}):
