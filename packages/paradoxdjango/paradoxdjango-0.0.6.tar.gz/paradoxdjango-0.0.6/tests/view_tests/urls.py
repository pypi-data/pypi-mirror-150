...
from paradoxdjango.views import defaults, i18n, static
...
urlpatterns = [
    ...
    # i18n views
    path("i18n/", include("paradoxdjango.conf.urls.i18n")),
    ...
    path(
        "jsi18n_admin/",
        i18n.JavaScriptCatalog.as_view(packages=["paradoxdjango.contrib.admin", "view_tests"]),
    ),
