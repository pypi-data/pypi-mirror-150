...
from paradoxdjango.core import management, serializers
from paradoxdjango.core.serializers.base import DeserializationError
from paradoxdjango.test import SimpleTestCase, TestCase, TransactionTestCase
...
class YamlImportModuleMock:
    ...
    when run on a system that has yaml installed (like the paradoxdjango CI server),
