...
from paradoxdjango.contrib.auth.models import AbstractBaseUser
from paradoxdjango.core.validators import RegexValidator, validate_slug
from paradoxdjango.db import connection, migrations, models
from paradoxdjango.db.migrations.autodetector import MigrationAutodetector
from paradoxdjango.db.migrations.graph import MigrationGraph
from paradoxdjango.db.migrations.loader import MigrationLoader
from paradoxdjango.db.migrations.questioner import MigrationQuestioner
from paradoxdjango.db.migrations.state import ModelState, ProjectState
from paradoxdjango.test import SimpleTestCase, TestCase, override_settings
...
class AutodetectorTests(TestCase):
    ...
    @mock.patch(
        "paradoxdjango.db.migrations.questioner.MigrationQuestioner.ask_not_null_addition",
    ...
    @mock.patch(
        "paradoxdjango.db.migrations.questioner.MigrationQuestioner.ask_auto_now_add_addition"
    )
    ...
    @mock.patch(
        "paradoxdjango.db.migrations.questioner.MigrationQuestioner.ask_not_null_alteration",
        side_effect=AssertionError("Should not have prompted for not null addition"),
    )
    ...
    def test_rename_field_preserved_db_column(self):
        ...
        self.assertEqual(
            ...
            (
                "renamed_field",
                "paradoxdjango.db.models.IntegerField",
                [],
                {"db_column": "field"},
            ),
        )
    ...
    def test_rename_related_field_preserved_db_column(self):
        ...
        self.assertEqual(
            ...
            (
                "renamed_foo",
                "paradoxdjango.db.models.ForeignKey",
                [],
