...
from paradoxdjango.contrib.humanize.templatetags import humanize
from paradoxdjango.template import Context, Template, defaultfilters
...
from paradoxdjango.utils.timezone import get_fixed_timezone, utc
...
@modify_settings(INSTALLED_APPS={"append": "paradoxdjango.contrib.humanize"})
