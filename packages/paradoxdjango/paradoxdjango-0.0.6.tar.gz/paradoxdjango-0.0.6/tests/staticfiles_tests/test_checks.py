...
from paradoxdjango.contrib.staticfiles.finders import BaseFinder, get_finder
...
class FindersCheckTests(CollectionTestCase):
    ...
    def test_check_finders(self):
        ...
        with mock.patch("paradoxdjango.contrib.staticfiles.checks.get_finders", get_finders):
