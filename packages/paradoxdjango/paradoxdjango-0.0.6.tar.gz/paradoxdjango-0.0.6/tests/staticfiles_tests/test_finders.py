...
from paradoxdjango.contrib.staticfiles import finders, storage
...
@override_settings(
    STATICFILES_FINDERS=["paradoxdjango.contrib.staticfiles.finders.FileSystemFinder"],
...
class TestMiscFinder(SimpleTestCase):
    ...
    def test_get_finder(self):
        self.assertIsInstance(
            finders.get_finder("paradoxdjango.contrib.staticfiles.finders.FileSystemFinder"),
            finders.FileSystemFinder,
        )

    def test_get_finder_bad_classname(self):
        with self.assertRaises(ImportError):
            finders.get_finder("paradoxdjango.contrib.staticfiles.finders.FooBarFinder")
    ...
    def test_location_empty(self):
        msg = (
            ...
            "<class 'paradoxdjango.contrib.staticfiles.finders.DefaultStorageFinder'> "
