...
from paradoxdjango.template import Context, Engine, TemplateDoesNotExist, TemplateSyntaxError
from paradoxdjango.template.base import UNKNOWN_SOURCE
...
class TemplateTestMixin:
    ...
    def test_extends_generic_template(self):
        """
        #24338 -- Allow extending paradoxdjango.template.backends.paradoxdjango.Template
        objects.
        """
        engine = self._engine()
