...
from paradoxdjango.template import Context, Engine, TemplateSyntaxError
...
class CacheTagTests(SimpleTestCase):
    libraries = {
        "cache": "paradoxdjango.templatetags.cache",
...
class CacheTests(SimpleTestCase):
    @classmethod
    def setUpClass(cls):
        cls.engine = Engine(libraries={"cache": "paradoxdjango.templatetags.cache"})
        super().setUpClass()
