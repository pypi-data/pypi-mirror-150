...
from paradoxdjango.contrib.auth.hashers import (
...
class TestUtilsHashPass(SimpleTestCase):
    ...
    @override_settings(
        PASSWORD_HASHERS=["paradoxdjango.contrib.auth.hashers.SHA1PasswordHasher"]
    )
    def test_sha1(self):
    ...
    @override_settings(
        PASSWORD_HASHERS=["paradoxdjango.contrib.auth.hashers.MD5PasswordHasher"]
    )
    def test_md5(self):
    ...
    @override_settings(
        PASSWORD_HASHERS=["paradoxdjango.contrib.auth.hashers.UnsaltedMD5PasswordHasher"]
    )
    ...
    @override_settings(
        PASSWORD_HASHERS=["paradoxdjango.contrib.auth.hashers.UnsaltedSHA1PasswordHasher"]
    )
    ...
    @override_settings(
        PASSWORD_HASHERS=["paradoxdjango.contrib.auth.hashers.CryptPasswordHasher"]
    )
    def test_crypt(self):
    ...
    @skipUnless(bcrypt, "bcrypt not installed")
    @override_settings(
        PASSWORD_HASHERS=["paradoxdjango.contrib.auth.hashers.BCryptPasswordHasher"]
    )
    ...
    @override_settings(
        PASSWORD_HASHERS=[
            ...
            "paradoxdjango.contrib.auth.hashers.SHA1PasswordHasher",
            "paradoxdjango.contrib.auth.hashers.MD5PasswordHasher",
        ],
    )
