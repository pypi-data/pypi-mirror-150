...
from paradoxdjango.contrib.auth import (
    BACKEND_SESSION_KEY,
    SESSION_KEY,
    _clean_credentials,
    authenticate,
...
from paradoxdjango.contrib.auth.backends import BaseBackend, ModelBackend
from paradoxdjango.contrib.auth.hashers import MD5PasswordHasher
from paradoxdjango.contrib.auth.models import AnonymousUser, Group, Permission, User
from paradoxdjango.contrib.contenttypes.models import ContentType
from paradoxdjango.core.exceptions import ImproperlyConfigured, PermissionDenied
...
from paradoxdjango.views.debug import technical_500_response
from paradoxdjango.views.decorators.debug import sensitive_variables
...
class BaseModelBackendTest:
    ...
    backend = "paradoxdjango.contrib.auth.backends.ModelBackend"
...
class SelectingBackendTests(TestCase):
    ...
    def test_non_string_backend(self):
        ...
        expected_message = (
            ...
            "<class 'paradoxdjango.contrib.auth.backends.ModelBackend'>)."
        )
