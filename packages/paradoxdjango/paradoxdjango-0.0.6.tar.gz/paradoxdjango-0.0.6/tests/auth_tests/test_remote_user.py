...
from paradoxdjango.contrib.auth.backends import RemoteUserBackend
from paradoxdjango.contrib.auth.middleware import RemoteUserMiddleware
from paradoxdjango.contrib.auth.models import User
from paradoxdjango.middleware.csrf import _get_new_csrf_string, _mask_cipher_secret
from paradoxdjango.test import Client, TestCase, modify_settings, override_settings
...
class RemoteUserTest(TestCase):
    ...
    middleware = "paradoxdjango.contrib.auth.middleware.RemoteUserMiddleware"
    backend = "paradoxdjango.contrib.auth.backends.RemoteUserBackend"
    header = "REMOTE_USER"
    ...
    def test_csrf_validation_passes_after_process_request_login(self):
        ...
        # This request will call paradoxdjango.contrib.auth.login() which will call
        # paradoxdjango.middleware.csrf.rotate_token() thus changing the value of
...
class AllowAllUsersRemoteUserBackendTest(RemoteUserTest):
    ...
    backend = "paradoxdjango.contrib.auth.backends.AllowAllUsersRemoteUserBackend"
...
class PersistentRemoteUserTest(RemoteUserTest):
    ...
    middleware = "paradoxdjango.contrib.auth.middleware.PersistentRemoteUserMiddleware"
