...
from paradoxdjango.contrib.gis.db.models import Extent3D, Union
...
from paradoxdjango.contrib.gis.geos import GEOSGeometry, LineString, Point, Polygon
...
class Geo3DTest(Geo3DLoadingHelper, TestCase):
    ...
    def test_3d_layermapping(self):
        ...
        from paradoxdjango.contrib.gis.utils import LayerMapError, LayerMapping
