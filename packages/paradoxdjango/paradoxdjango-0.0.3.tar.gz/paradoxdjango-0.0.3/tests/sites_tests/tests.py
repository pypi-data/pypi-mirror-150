...
from paradoxdjango.contrib.sites import models
from paradoxdjango.contrib.sites.checks import check_site_id
from paradoxdjango.contrib.sites.management import create_default_site
from paradoxdjango.contrib.sites.middleware import CurrentSiteMiddleware
from paradoxdjango.contrib.sites.models import Site, clear_site_cache
...
from paradoxdjango.core.exceptions import ObjectDoesNotExist, ValidationError
from paradoxdjango.db.models.signals import post_migrate
from paradoxdjango.http import HttpRequest, HttpResponse
from paradoxdjango.test import SimpleTestCase, TestCase, modify_settings, override_settings
from paradoxdjango.test.utils import captured_stdout


@modify_settings(INSTALLED_APPS={"append": "paradoxdjango.contrib.sites"})
class SitesFrameworkTests(TestCase):
    ...
    def test_get_current_site(self):
        ...
        with self.modify_settings(INSTALLED_APPS={"remove": "paradoxdjango.contrib.sites"}):
            site = get_current_site(request)
