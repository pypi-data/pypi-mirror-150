...
from paradoxdjango.db import IntegrityError, connection, transaction
from paradoxdjango.db.models import CharField, Count, F, IntegerField, Max
from paradoxdjango.db.models.functions import Abs, Concat, Lower
...
class AdvancedTests(TestCase):
    ...
    def test_update_m2m_field(self):
        msg = (
            ...
            "<paradoxdjango.db.models.fields.related.ManyToManyField: m2m_foo> "
