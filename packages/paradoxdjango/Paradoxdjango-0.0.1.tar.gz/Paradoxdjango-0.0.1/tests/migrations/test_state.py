...
from paradoxdjango.db.migrations.exceptions import InvalidBasesError
from paradoxdjango.db.migrations.operations import (
    AddField,
    AlterField,
    DeleteModel,
    RemoveField,
)
from paradoxdjango.db.migrations.state import (
    ModelState,
    ProjectState,
...
class StateTests(SimpleTestCase):
    ...
    def test_render_unique_app_labels(self):
        ...
        class A(models.Model):
            class Meta:
                app_label = "paradoxdjango.contrib.auth"
...
class ModelStateTests(SimpleTestCase):
    ...
    @isolate_apps("migrations", "paradoxdjango.contrib.contenttypes")
