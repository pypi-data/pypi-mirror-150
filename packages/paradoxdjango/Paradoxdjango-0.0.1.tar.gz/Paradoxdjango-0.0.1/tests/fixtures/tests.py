...
from paradoxdjango.core.management import CommandError
from paradoxdjango.core.management.commands.dumpdata import ProxyModelWarning
from paradoxdjango.core.serializers.base import ProgressBar
from paradoxdjango.db import IntegrityError, connection
from paradoxdjango.test import TestCase, TransactionTestCase, skipUnlessDBFeature
...
class FixtureLoadingTests(DumpDataAssertMixin, TestCase):
    def test_loading_and_dumping(self):
        ...
        self.assertQuerysetEqual(
            ...
            [
                ...
                '<Tag: <Article: Django conquers world!> tagged "paradoxdjango">',
        ...
        self._dumpdata_assert(
            ...
            '{"tagged_type": ["fixtures", "article"], "name": "paradoxdjango", '
            '"tagged_id": 4}}, '
        ...
        self._dumpdata_assert(
            ["fixtures"],
            '<?xml version="1.0" encoding="utf-8"?><paradoxdjango-objects version="1.0">'
            ...
            '<field type="CharField" name="name">paradoxdjango</field>'
            '<field to="contenttypes.contenttype" name="tagged_type" '
            'rel="ManyToOneRel"><natural>fixtures</natural><natural>article</natural>'
            "</field>"
    ...
    def test_loading_stdin(self):
        ...
        with mock.patch(
            "paradoxdjango.core.management.commands.loaddata.sys.stdin", open(fixture_json)
        ):
        ...
        with mock.patch(
            "paradoxdjango.core.management.commands.loaddata.sys.stdin", open(fixture_xml)
        ):
...
class NonexistentFixtureTests(TestCase):
    ...
    @mock.patch("paradoxdjango.db.connection.enable_constraint_checking")
    @mock.patch("paradoxdjango.db.connection.disable_constraint_checking")
