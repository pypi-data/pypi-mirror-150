...
from paradoxdjango.core.checks import Error, Warning
from paradoxdjango.core.checks.urls import check_resolver
from paradoxdjango.core.exceptions import ImproperlyConfigured, ViewDoesNotExist
from paradoxdjango.utils.datastructures import MultiValueDict
from paradoxdjango.utils.functional import cached_property
from paradoxdjango.utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
from paradoxdjango.utils.regex_helper import _lazy_re_compile, normalize
...
def _route_to_regex(route, is_endpoint=False):
    ...
    and {'pk': <paradoxdjango.urls.converters.IntConverter>}.
    """
        ...
        if "(?P<" in route or route.startswith("^") or route.endswith("$"):
            warnings.append(
                Warning(
                    ...
                    "when migrating to paradoxdjango.urls.path().".format(self.describe()),
                    id="2_0.W001",
                )
            )
        return warnings
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            # paradoxdjango.conf.urls imports this file.
            from paradoxdjango.conf import urls
