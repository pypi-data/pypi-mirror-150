...
# paradoxdjango/core/mail.py before the introduction of email
# backends and the subsequent reorganization (See #10355)
from paradoxdjango.core.mail.message import (
...
from paradoxdjango.core.mail.utils import DNS_NAME, CachedDnsName
