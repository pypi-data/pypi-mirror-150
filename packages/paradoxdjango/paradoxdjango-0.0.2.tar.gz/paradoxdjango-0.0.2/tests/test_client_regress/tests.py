...
from paradoxdjango.contrib.auth.signals import user_logged_in, user_logged_out
from paradoxdjango.http import HttpResponse
from paradoxdjango.template import Context, RequestContext, TemplateSyntaxError, engines
from paradoxdjango.template.response import SimpleTemplateResponse
...
from paradoxdjango.test.client import RedirectCycleError, RequestFactory, encode_file
...
class AssertContainsTests(SimpleTestCase):
    ...
    def test_assert_contains_renders_template_response(self):
        ...
        """
        template = engines["paradoxdjango"].from_string("Hello")
...
class AssertRedirectsTests(SimpleTestCase):
    ...
    def test_redirect_fetch_redirect_response(self):
        """Preserve extra headers of requests made with paradoxdjango.test.Client."""
        methods = (
            "get",
            "post",
            "head",
