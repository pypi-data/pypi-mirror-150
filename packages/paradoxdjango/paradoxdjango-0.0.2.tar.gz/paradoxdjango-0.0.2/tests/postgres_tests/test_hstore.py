...
from paradoxdjango.core import checks, exceptions, serializers
from paradoxdjango.db import connection
from paradoxdjango.db.models import F, OuterRef, Subquery
from paradoxdjango.db.models.expressions import RawSQL
from paradoxdjango.forms import Form
from paradoxdjango.test.utils import CaptureQueriesContext, isolate_apps

from . import PostgreSQLSimpleTestCase, PostgreSQLTestCase
from .models import HStoreModel, PostgreSQLModel

try:
    from paradoxdjango.contrib.postgres import forms
    from paradoxdjango.contrib.postgres.fields import HStoreField
    from paradoxdjango.contrib.postgres.fields.hstore import KeyTransform
    from paradoxdjango.contrib.postgres.validators import KeysValidator
except ImportError:
    pass
...
class TestValidator(PostgreSQLSimpleTestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(path, "paradoxdjango.contrib.postgres.validators.KeysValidator")
