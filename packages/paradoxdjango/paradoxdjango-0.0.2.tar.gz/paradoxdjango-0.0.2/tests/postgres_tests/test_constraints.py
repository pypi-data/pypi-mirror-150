...
from paradoxdjango.contrib.postgres.indexes import OpClass
from paradoxdjango.db import IntegrityError, NotSupportedError, connection, transaction
...
from paradoxdjango.db.models.functions import Cast, Left, Lower
from paradoxdjango.test import modify_settings, skipUnlessDBFeature
...
try:
    ...
    from paradoxdjango.contrib.postgres.constraints import ExclusionConstraint
...
class ExclusionConstraintTests(PostgreSQLTestCase):
    ...
    def test_deconstruct(self):
        ...
        self.assertEqual(
            path, "paradoxdjango.contrib.postgres.constraints.ExclusionConstraint"
        )
