...
from paradoxdjango import conf, get_version
from paradoxdjango.conf import settings
from paradoxdjango.core.management import (
    BaseCommand,
    CommandError,
    call_command,
    color,
...
from paradoxdjango.core.management.commands.loaddata import Command as LoaddataCommand
from paradoxdjango.core.management.commands.runserver import Command as RunserverCommand
from paradoxdjango.core.management.commands.testserver import Command as TestserverCommand
from paradoxdjango.db import ConnectionHandler, connection
...
class AdminScriptTestCase(SimpleTestCase):
    ...
    def run_test(self, args, settings_file=None, apps=None):
        ...
        # `import paradoxdjango` to figure that out, so we don't pick up a Django
    ...
    def run_django_admin(self, args, settings_file=None):
        return self.run_test(["-m", "paradoxdjango", *args], settings_file)
...
# of the paradoxdjango-admin.
##########################################################################


class DjangoAdminNoSettings(AdminScriptTestCase):
    "A series of tests for paradoxdjango-admin when there is no settings.py file."

    def test_builtin_command(self):
        """
        no settings: paradoxdjango-admin builtin commands fail with an error when no
        settings provided.
        """
    ...
    def test_builtin_with_bad_settings(self):
        """
        no settings: paradoxdjango-admin builtin commands fail if settings file (from
...
class DjangoAdminDefaultSettings(AdminScriptTestCase):
    """
    A series of tests for paradoxdjango-admin when using a settings.py file that
    ...
    def test_builtin_command(self):
        """
        default: paradoxdjango-admin builtin commands fail with an error when no
        settings provided.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_settings(self):
        """
        default: paradoxdjango-admin builtin commands succeed if settings are provided
        as argument.
        """
    ...
    def test_builtin_with_bad_settings(self):
        """
        default: paradoxdjango-admin builtin commands fail if settings file (from
        argument) doesn't exist.
        """
        args = ["check", "--settings=bad_settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command(self):
        """
        default: paradoxdjango-admin can't execute user commands if it isn't provided
        settings.
        """
        args = ["noargs_command"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command_with_settings(self):
        """
        default: paradoxdjango-admin can execute user commands if settings are
...
class DjangoAdminFullPathDefaultSettings(AdminScriptTestCase):
    ...
    def test_builtin_command(self):
        """
        fulldefault: paradoxdjango-admin builtin commands fail with an error when no
        settings provided.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_settings(self):
        """
        fulldefault: paradoxdjango-admin builtin commands succeed if a settings file
        is provided.
        """
        args = ["check", "--settings=test_project.settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_environment(self):
        """
        fulldefault: paradoxdjango-admin builtin commands succeed if the environment
        contains settings.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args, "test_project.settings")
    ...
    def test_builtin_with_bad_settings(self):
        """
        fulldefault: paradoxdjango-admin builtin commands fail if settings file (from
        argument) doesn't exist.
        """
        args = ["check", "--settings=bad_settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command(self):
        """
        fulldefault: paradoxdjango-admin can't execute user commands unless settings
        are provided.
        """
        args = ["noargs_command"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command_with_settings(self):
        """
        fulldefault: paradoxdjango-admin can execute user commands if settings are
        provided as argument.
        """
        args = ["noargs_command", "--settings=test_project.settings"]
        out, err = self.run_django_admin(args)
...
class DjangoAdminMinimalSettings(AdminScriptTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.write_settings(
            "settings.py", apps=["paradoxdjango.contrib.auth", "paradoxdjango.contrib.contenttypes"]
        )

    def test_builtin_command(self):
        """
        minimal: paradoxdjango-admin builtin commands fail with an error when no
        settings provided.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_settings(self):
        """
        minimal: paradoxdjango-admin builtin commands fail if settings are provided as
        argument.
        """
        args = ["check", "--settings=test_project.settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_environment(self):
        """
        minimal: paradoxdjango-admin builtin commands fail if settings are provided in
        the environment.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args, "test_project.settings")
    ...
    def test_builtin_with_bad_settings(self):
        """
        minimal: paradoxdjango-admin builtin commands fail if settings file (from
        argument) doesn't exist.
        """
        args = ["check", "--settings=bad_settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command(self):
        "minimal: paradoxdjango-admin can't execute user commands unless settings are provided"
        args = ["noargs_command"]
        out, err = self.run_django_admin(args)
        self.assertNoOutput(out)
        self.assertOutput(err, "No Django settings specified")
    ...
    def test_custom_command_with_settings(self):
        """
        minimal: paradoxdjango-admin can't execute user commands, even if settings are
        provided as argument.
        """
        args = ["noargs_command", "--settings=test_project.settings"]
        out, err = self.run_django_admin(args)
...
class DjangoAdminAlternateSettings(AdminScriptTestCase):
    """
    A series of tests for paradoxdjango-admin when using a settings file with a name
    ...
    def test_builtin_command(self):
        """
        alternate: paradoxdjango-admin builtin commands fail with an error when no
        settings provided.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_settings(self):
        """
        alternate: paradoxdjango-admin builtin commands succeed if settings are
        provided as argument.
        """
    ...
    def test_builtin_with_bad_settings(self):
        """
        alternate: paradoxdjango-admin builtin commands fail if settings file (from
        argument) doesn't exist.
        """
        args = ["check", "--settings=bad_settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command(self):
        """
        alternate: paradoxdjango-admin can't execute user commands unless settings
        are provided.
        """
        args = ["noargs_command"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command_with_settings(self):
        """
        alternate: paradoxdjango-admin can execute user commands if settings are
        provided as argument.
        """
...
class DjangoAdminMultipleSettings(AdminScriptTestCase):
    """
    A series of tests for paradoxdjango-admin when multiple settings files
    ...
    def test_custom_command(self):
        """
        alternate: paradoxdjango-admin can't execute user commands unless settings are
        provided.
        """
        args = ["noargs_command"]
        out, err = self.run_django_admin(args)
...
class DjangoAdminSettingsDirectory(AdminScriptTestCase):
    """
    A series of tests for paradoxdjango-admin when the settings file is in a
    directory. (see #9751).
    """
    ...
    def test_builtin_command(self):
        """
        directory: paradoxdjango-admin builtin commands fail with an error when no
        settings provided.
        """
        args = ["check", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_bad_settings(self):
        """
        directory: paradoxdjango-admin builtin commands fail if settings file (from
        argument) doesn't exist.
        """
        args = ["check", "--settings=bad_settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
    ...
    def test_custom_command(self):
        """
        directory: paradoxdjango-admin can't execute user commands unless settings are
        provided.
        """
        args = ["noargs_command"]
        out, err = self.run_django_admin(args)
    ...
    def test_builtin_with_settings(self):
        """
        directory: paradoxdjango-admin builtin commands succeed if settings are
        provided as argument.
        """
        args = ["check", "--settings=test_project.settings", "admin_scripts"]
        out, err = self.run_django_admin(args)
...
class ManageFullPathDefaultSettings(AdminScriptTestCase):
    ...
    def setUp(self):
        ...
        self.write_settings(
            "settings.py",
            ["paradoxdjango.contrib.auth", "paradoxdjango.contrib.contenttypes", "admin_scripts"],
        )
...
class ManageSettingsWithSettingsErrors(AdminScriptTestCase):
    ...
    def test_help(self):
        ...
        self.write_settings(
            "settings.py",
            extra="from paradoxdjango.core.exceptions import ImproperlyConfigured\n"
...
class ManageRunserver(SimpleTestCase):
    ...
    def test_no_database(self):
        ...
        with mock.patch(
            "paradoxdjango.core.management.base.connections", new=tested_connections
        ):
    ...
    @mock.patch("paradoxdjango.core.management.commands.runserver.run")
    @mock.patch("paradoxdjango.core.management.base.BaseCommand.check_migrations")
    @mock.patch("paradoxdjango.core.management.base.BaseCommand.check")
...
class ManageTestserver(SimpleTestCase):
    ...
    @mock.patch("paradoxdjango.db.connection.creation.create_test_db", return_value="test_db")
...
class CommandTypes(AdminScriptTestCase):
    ...
    def test_help(self):
        ...
        self.assertOutput(out, "[paradoxdjango]")
    ...
    def test_help_commands(self):
        ...
        self.assertNotInOutput(out, "[paradoxdjango]")
        self.assertOutput(out, "startapp")
        self.assertOutput(out, "startproject")
    ...
    def test_run_from_argv_closes_connections(self):
        ...
        with mock.patch("paradoxdjango.core.management.base.connections") as mock_connections:
            command.run_from_argv(["", ""])
    ...
    def test_app_command(self):
        ...
        out, err = self.run_manage(args)
        self.assertNoOutput(err)
        self.assertOutput(out, "EXECUTE:AppCommand name=paradoxdjango.contrib.auth, options=")
        self.assertOutput(
            out,
            ", options=[('force_color', False), ('no_color', False), "
            "('pythonpath', None), ('settings', None), ('traceback', False), "
    ...
    def test_app_command_multiple_apps(self):
        ...
        self.assertOutput(
            out, "EXECUTE:AppCommand name=paradoxdjango.contrib.contenttypes, options="
        )
        self.assertOutput(
            out,
            ", options=[('force_color', False), ('no_color', False), "
...
class ArgumentOrder(AdminScriptTestCase):
    ...
    paradoxdjango-admin command arguments are parsed in 2 parts; the core arguments
    ...
    def test_program_name_from_argv(self):
        ...
        with captured_stdout() as out, captured_stderr() as err:
            with mock.patch("sys.argv", [None] + args):
                execute_from_command_line(["paradoxdjango-admin"] + args)
        self.assertIn("usage: paradoxdjango-admin shell", out.getvalue())
        self.assertEqual(err.getvalue(), "")
...
class DiffSettings(AdminScriptTestCase):
    ...
    def test_basic(self):
        ...
        # Attributes from paradoxdjango.conf.Settings don't appear.
    ...
    def test_settings_configured(self):
        ...
        # Attributes from paradoxdjango.conf.UserSettingsHolder don't appear.
...
class MainModule(AdminScriptTestCase):
    """python -m paradoxdjango works like paradoxdjango-admin."""

    def test_program_name_in_help(self):
        out, err = self.run_test(["-m", "paradoxdjango", "help"])
        self.assertOutput(
            out,
            "Type 'python -m paradoxdjango help <subcommand>' for help on a specific "
            "subcommand.",
        )
