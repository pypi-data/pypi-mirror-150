...
from paradoxdjango.contrib.auth.context_processors import PermLookupDict, PermWrapper
...
class AuthContextProcessorTests(TestCase):
    """
    Tests for the ``paradoxdjango.contrib.auth.context_processors.auth`` processor
    """
