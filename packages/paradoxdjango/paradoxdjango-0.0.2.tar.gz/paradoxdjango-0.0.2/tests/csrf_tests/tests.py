...
from paradoxdjango.contrib.sessions.backends.cache import SessionStore
from paradoxdjango.core.exceptions import ImproperlyConfigured
from paradoxdjango.http import HttpRequest, HttpResponse, UnreadablePostError
from paradoxdjango.middleware.csrf import (
    CSRF_ALLOWED_CHARS,
    CSRF_SECRET_LENGTH,
    CSRF_SESSION_KEY,
    CSRF_TOKEN_LENGTH,
...
from paradoxdjango.views.decorators.csrf import csrf_exempt, requires_csrf_token
...
class CsrfViewMiddlewareTestMixin(CsrfFunctionTestMixin):
    ...
    def _check_bad_or_missing_cookie(self, cookie, expected):
        ...
        mw.process_request(req)
        with self.assertLogs("paradoxdjango.security.csrf", "WARNING") as cm:
    ...
    def test_ensures_csrf_cookie_no_logging(self):
        ...
        """
        with self.assertNoLogs("paradoxdjango.request", "WARNING"):
            req = self._get_request()
