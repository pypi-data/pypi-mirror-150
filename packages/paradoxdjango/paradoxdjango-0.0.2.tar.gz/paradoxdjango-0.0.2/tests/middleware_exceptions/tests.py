...
from paradoxdjango.core.exceptions import MiddlewareNotUsed
...
class MiddlewareNotUsedTests(SimpleTestCase):
    ...
    def test_log(self):
        with self.assertLogs("paradoxdjango.request", "DEBUG") as cm:
            self.client.get("/middleware_exceptions/view/")
        self.assertEqual(
    ...
    def test_do_not_log_when_debug_is_false(self):
        with self.assertNoLogs("paradoxdjango.request", "DEBUG"):
            self.client.get("/middleware_exceptions/view/")
