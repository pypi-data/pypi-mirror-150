...
from paradoxdjango.test import TestCase, skipUnlessAnyDBFeature, skipUnlessDBFeature
...
class AggregationTests(TestCase):
    ...
    def test_aggregate_unmanaged_model_as_tables(self):
        ...
        with mock.patch(
            "paradoxdjango.db.connection.features.allows_group_by_selected_pks_on_model",
            return_value=True,
        ):
