...
class SeleniumTests(AdminSeleniumTestCase):
    ...
    def setUp(self):
        ...
        self.selenium.execute_script(
            "localStorage.removeItem('paradoxdjango.admin.navSidebarIsOpen')"
        )
    ...
    def test_sidebar_state_persists(self):
        ...
        self.assertIsNone(
            self.selenium.execute_script(
                "return localStorage.getItem('paradoxdjango.admin.navSidebarIsOpen')"
            )
        )
        toggle_button = self.selenium.find_element_by_css_selector(
            "#toggle-nav-sidebar"
    ...
    def test_sidebar_filter_persists(self):
        ...
        filter_value_script = (
            "return sessionStorage.getItem('paradoxdjango.admin.navSidebarFilterValue')"
        )
