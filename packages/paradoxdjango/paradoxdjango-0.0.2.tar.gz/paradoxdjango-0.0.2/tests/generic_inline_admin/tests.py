...
from paradoxdjango.contrib.contenttypes.admin import GenericTabularInline
from paradoxdjango.contrib.contenttypes.models import ContentType
from paradoxdjango.forms.formsets import DEFAULT_MAX_NUM
from paradoxdjango.forms.models import ModelForm
