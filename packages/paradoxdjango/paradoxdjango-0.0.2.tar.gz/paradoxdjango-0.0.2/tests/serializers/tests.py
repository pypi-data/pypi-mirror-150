...
from paradoxdjango.core.serializers import SerializerDoesNotExist
from paradoxdjango.core.serializers.base import PickleSerializer, ProgressBar
from paradoxdjango.db import connection, transaction
...
from paradoxdjango.test.utils import Approximate
...
@override_settings(
    SERIALIZATION_MODULES={
        "json2": "paradoxdjango.core.serializers.json",
    }
)
class SerializerRegistrationTests(SimpleTestCase):
    ...
    def test_register(self):
        ...
        serializers.register_serializer("json3", "paradoxdjango.core.serializers.json")
...
class SerializersTestBase:
    ...
    def test_deserialize_force_insert(self):
        ...
        with mock.patch("paradoxdjango.db.models.Model") as mock_model:
