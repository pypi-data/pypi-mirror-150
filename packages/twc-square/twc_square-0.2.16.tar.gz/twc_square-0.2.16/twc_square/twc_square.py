...
def get_rules() :
    InferenceRules = dict(
        ...
        Object_Property_Inclusion_One = { # prp-spo1 -- aligns with 9.2.1 Object Subproperties   Object_Property_Individual_Inclusion
        ...
        Object_Property_Inclusion_Two = { # scm-spo          Object_Property_Property_Inclusion
        ...
        Data_Property_Inclusion_One = { # prp-spo1  -- also in line with 9.3.1 Data Subproperties   Data_Property_Individual_Inclusion
        ...
        Data_Property_Inclusion_Two = { # scm-spo       Data_Property_Property_Inclusion
        ...
        Class_Equivalence_One = { # cax-eqc1  and cax-eqc2-- somewhat aligns with 9.1.2 Equivalent Classes -- in those examples they use value restrictions Class_Equivalence_Inclusion
        ...
        Class_Equivalence_Two = { # cax-eqc1 -- aligns with 9.1.2 Equivalent Classes     Class_Equivalence_Definition
        ...
        Class_Equivalence_Three = { # cax-eqc2       Class_Equivalence_Definition_Inverse
        ...
        Object_Property_Equivalence_One = { # prp-eqp1 and prp-eqp2-- aligns with 9.2.2 Equivalent Object Properties    Object_Property_Equivalence_Substitution
        ...
        Object_Property_Equivalence_Two = { # scm-eqp1  -- aligns with 9.2.2 Equivalent Object Properties   Object_Property_Equivalence_Defintion
        ...
        Object_Property_Equivalence_Three = { # scm-eqp2 Object_Property_Equivalence_Inverse_Defintion
        ...
        Data_Property_Equivalence_One = { # prp-eqp1 and prp-eqp2  -- also in line with 9.3.2 Equivalent Data Properties          Data_Property_Equivalence_Substitution
        ...
        Data_Property_Equivalence_Two = { # scm-eqp1   Data_Property_Equivalence_Defintion
        ...
        Data_Property_Equivalence_Three = { # scm-eqp2    Data_Property_Equivalence_Inverse_Defintion
        ...
        Object_Some_Values_From_One = {# cls-svf1 , cls-svf2 -- in line with 8.2.1 Existential Quantification      Object_Some_Values_From_Assertion
        ...
        Object_Some_Values_From_Two = {# scm-svf1  Object_Some_Values_From_Inclusion  or Object_Some_Values_From_Subsumption
