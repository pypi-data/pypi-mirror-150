...
class scTDClib:
    ...
    def __init__(self):
        ...
        if os.name == 'nt':
            ...
            os.chdir(os.path.split(MODULE_DIR)[0] + '\\control\\tdc_surface_concept\\')
...
class scTDC_hdf5lib:
    def __init__(self):
        ...
        if os.name == 'nt':
            os.chdir(
                os.getcwd() + '\\tdc_surface_concept\\')  # directory has to be changed to be changed to the directory of dlls
