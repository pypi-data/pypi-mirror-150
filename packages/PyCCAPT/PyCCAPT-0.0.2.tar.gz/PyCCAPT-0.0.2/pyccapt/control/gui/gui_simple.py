...
from pyccapt.control.tools import tof2mc_simple, variables
...
"}")
    ...
    def thread_main(self):
            ...
            variables.path = os.path.join(os.path.split(MODULE_DIR)[0],
                                          'data_laser_pulse_mode\\%s' % variables.exp_name)
