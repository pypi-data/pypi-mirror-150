...
ga_dic = AttrDict.from_nested_dicts({
    **ga_conf('interference', dt=1 / 16, refID='None.100controls', m0='explorer',m1='coupled_oscillator_explorer',
              fit_kws={'target_fov_curve': None},
              spaceIDs=['interference'], fitID='interference', plotID='interference',
              Nel=4, N=40, envID='arena_200mm'),
    **ga_conf('exploration', dur=1, dt=1 / 16, refID='None.100controls', m0='Sakagiannis2022',
              m1='realistic_explorer', fit_kws={'eval_shorts': ['b', 'bv', 'ba', 'tur_fou', 'tur_t', 'tor5']},
              spaceIDs=['interference', 'physics', 'turner'], fitID='distro_KS', plotID='distro_KS',
              excl_func=bend_error_exclusion,
              Nel=2, N=10, envID='arena_500mm'),
    **ga_conf('realism', dur=1, dt=1 / 16, refID='None.100controls', m0='Sakagiannis2022',m1='realistic_coupled_explorer',
              fit_kws={'eval_shorts': ['b', 'bv', 'ba', 'tur_fou', 'tur_t', 'tor5'], 'target_fov_curve': None},
              spaceIDs=['physics'], fitID='distro_KS_interference', plotID='interference', init='model',
