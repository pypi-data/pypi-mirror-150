...
def init_pars():
    ...
    d = {
        ...
        'physics': {
            'torque_coef': {'v': 0.41, 'min': 0.0,'max': 5.0, 'dv': 0.01,'label' : 'torque coefficient', 'symbol': sub('c', 'T'), 'u' : sup('sec', -2),
            ...
            'ang_damping': {'v': 2.5, 'min': 0.0,'max': 10.0,'label' : 'angular damping', 'symbol': 'z', 'u' : sup('sec', -1),
                            'h': 'Angular damping exerted on angular velocity.'},
            'body_spring_k': {'v': 0.25,'min': 0.0, 'max': 100.0, 'dv': 0.01,'label' : 'body spring constant', 'symbol': 'k', 'u' : sup('sec', -2),
                              'h': 'Larva-body torsional spring constant reflecting deformation resistance.'},
            'bend_correction_coef': {'v': 1.0, 'min': 0.0,'max': 2.0,'label' : 'bend correction coefficient', 'symbol': sub('c', 'b'), 'u' : '-',
