...
class ArubaOS505(NetworkDriver):
    ...
    def get_lldp_neighbors(self):
        ...
        lldp["E0"].append({"port": "Test_DJ_PORT_0", "hostname": "Test_DJ_HOTS_"})
        lldp["E1"].append({"port": "Test_DJ_PORT_1", "hostname": "Test_DJ_HOTS_"})
        lldp["E2"].append({"port": "Test_DJ_PORT_2", "hostname": "Test_DJ_HOTS_"})
        lldp["E3"].append({"port": "Test_DJ_PORT_3", "hostname": "Test_DJ_HOTS_"})
        lldp["E4"].append({"port": "Test_DJ_PORT_4", "hostname": "Test_DJ_HOTS_"})
        return lldp
