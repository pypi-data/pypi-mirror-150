    ...
    try:
        ...
        if output:
            ...
            if hp_manufacture in _data and hp_platform in _data and "Router" in _data and "Bridge" in _data:
                lldp["Local_Interface"] = data[1]
                lldp["Remote_Interface"] = data[3]
                lldp["Remote_Device"] = data[15]
            #FTTX
            elif cisco_fttx_platform in _data and "Router" not in _data and "Not" in _data and "Bridge" in _data:
                lldp["Local_Interface"] = data[1]
                lldp["Remote_Interface"] = data[3]
                lldp["Remote_Device"] = data[6]
            else:
                lldp["Local_Interface"] = "No Local Interface"
                lldp["Remote_Interface"] = "No Remote Interface"
                lldp["Remote_Device"] = "No Remote Device"
