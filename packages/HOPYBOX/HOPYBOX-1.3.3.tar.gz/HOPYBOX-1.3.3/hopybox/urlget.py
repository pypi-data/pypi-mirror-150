...
def hoget(url):
  ...
  try:
    with console.Console().status("\033[35mLoading url …"):
    ...
    if res.status_code == 200:
      ...
      with console.Console().status("\033[35mLoading information …"):
      ...
      if res.encoding != None:
        ...
        res.encoding = 'utf-8'
        with console.Console().status("\033[35mLoading text …\033[0m"):
