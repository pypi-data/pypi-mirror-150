...
class IasZoneSensor(BinarySensor):
    def __init__(self, hass_instance: HomeAssistantClient, sensor_info: dict) -> None:
        """
        | Initializes a zone sensor using a sensor data dict
        ...
        self.sensor_class = BinarySensorClass.IAS_ZONE

    async def _update_fields(self, event_details: dict) -> None:
        await super(IasZoneSensor, self)._update_fields(event_details)
