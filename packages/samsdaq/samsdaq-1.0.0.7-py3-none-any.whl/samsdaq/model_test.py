...
print("###### X_train")
X_train = pd.read_csv('https://github.com/yourms/beerwiki02/blob/main/X_train.csv')
print(X_train.shape)
print(type(X_train))
...
loaded_model = load_model('https://github.com/yourms/beerwiki02/blob/main/best_model.h5')
# 정수 인코딩
tokenizer = Tokenizer()
