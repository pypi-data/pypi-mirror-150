...
class MyCell:
    ...
    def trans_from_pyxl(self, cell):
        ...
        self.addr = '{0}{1}'.format(cell.column, cell.row)
    ...
    def eq(self, ref_cell):
        ''' ref_cell si also a MyCell type '''
        eq_type = namedtuple("eq_type", ['all', 'value', 'bcolor'])
        eq_value = self.value == ref_cell.value
        eq_bcolor = self.bcolour == ref_cell.bcolour
        eq_all = all((eq_value, eq_bcolor))
        return eq_type(eq_all, eq_value, eq_bcolor)
