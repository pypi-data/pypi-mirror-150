...
__all__ = ['Hayashi', 'modified_Hayashi', 'Hermes_2009', 'Hermes_2014', 'Hosoda',
           'Kandula', 'Leoni', 'Sommers', 'Yang']

def Hayashi(Tf):    
    r'''Calculates the frost density, rho_f, according to the Hayashi correlation (1977)
    ...
    References
    ----------
    ..[1] Hayashi, Y., Aoki, A., Hori, K., 1977. Study of frost properties correlating
    with frost formation types. J. Heat Transfer 99, 239-245.
    '''
    return 650*numpy.exp(0.277*Tf)


def modified_Hayashi(Tf, Tw):
    r'''Calculates the frost density, rho_f, according to the modified Hayashi
...
def Hermes_2009(lamb, t):
    ...
    References
    ----------
    ..[1] Hermes, C.J.L., Piucco, R.O., Melo, C., Barbosa Jr., J.R., 2009. A
    study of frost growth and densification on flat surfaces. Exp. Therm. Fluid
    Sci. 33, 371-379.
...
def Hermes_2014(Cp, Tsata, Tw, hsub, wa, wsatw, t):
    ...
    References
    ----------
    ..[1] Hermes, C. A semi-empirical correlation for the frost density
...
def Hosoda(Tw, Va):
    ...
    References
    ----------
    ..[1] Hosoda T, Uzuhashi H. Effects of frost on the heat transfer coefficient.
    Hitachi Reivew 1967;16(6):254-9.
    '''    
...
def Kandula(rho_i, Tf, Tw, Tm, Re, Rec):
    ...
    References
    ----------
    ..[1] Kandula, M., 2011. Correlation of water frost porosity in laminar 
    flow over flat surfaces. Special Top. Rev. Porous Media - Int. J. 3, 79-87
    '''    
...
def Mao(Re):
    r'''Calculates the frost density, rho_f, according to the Mao et. al (1992) correlation
    for a flat plate, which is valid for:
        -15  < Tw < -15  [C],
        15   < Ta < 23   [C], 
        1.15 < v  < 2.67 [m/s]
    ...
    References
    ----------
    ..[1] Mao, Y., Besant, R.W., Rezkallah, K.S., 1992. Measurement and correlations
    of frost properties with airflow over a flat plate. ASHRAE Trans. 98, 65-77.
    '''     
    return 1
