...
class EntityColumn(ProgressColumn):
    ...
    def _render_progress_bar(self, task: Task) -> RenderableType:
        ...
        style_map = {
            ...
            EntityStatus.BUILDING: (False, "default", ProgressStyle.BLACK),
            EntityStatus.TRAINING: (False, "default", ProgressStyle.BLACK),
            ...
            EntityStatus.RESULT_UPLOADING: (False, "default", ProgressStyle.BLUE),
            EntityStatus.ENTITY_DOWNLOADING: (False, "default", ProgressStyle.BLUE),
            EntityStatus.ENTITY_FROM_CACHE: (True, "default", ProgressStyle.DONE),
        }
        ...
        if (
            ...
            task.completed = (task.completed + fraction) % task.total
