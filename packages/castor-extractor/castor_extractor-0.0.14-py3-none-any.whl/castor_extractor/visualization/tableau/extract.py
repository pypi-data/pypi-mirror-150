...
def iterate_all_data(
    ...
    yield TableauEntity.WORKBOOK, deep_serialize(client.fetch(TableauEntity.WORKBOOK))

    logger.info("Extracting PROJECT from Tableau API")
    yield TableauEntity.PROJECT, deep_serialize(client.fetch(TableauEntity.PROJECT))
