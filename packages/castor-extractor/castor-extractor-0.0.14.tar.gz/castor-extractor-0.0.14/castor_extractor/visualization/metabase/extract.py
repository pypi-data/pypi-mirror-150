...
def iterate_all_data(
    ...
    yield MetabaseEntity.DATABASE, deep_serialize(client.fetch(MetabaseEntity.DATABASE))
    yield MetabaseEntity.TABLE, deep_serialize(client.fetch(MetabaseEntity.TABLE))
