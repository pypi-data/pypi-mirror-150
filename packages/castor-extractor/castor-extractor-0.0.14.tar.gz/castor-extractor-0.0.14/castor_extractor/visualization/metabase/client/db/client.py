...
class DbClient:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.encryption_secret_key = kwargs.get("encryption_secret_key") or from_env(
            ENCRYPTION_SECRET_KEY, allow_missing=True
        )
    ...
    def fetch(self, entity: MetabaseEntity) -> EntitiesType:
        ...
        return [{key: e.get(key) for key in EXPORTED_FIELDS[entity]} for e in entities]
