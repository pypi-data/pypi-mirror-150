...
class RatingManager(object):
    ...
    def get_rating_for_user(self, user, cookies={}):
    ...
    def add(self, score, user, cookies={}, commit=True):
    ...
    def delete(self, user, cookies={}, commit=True):
        return self.add(0, user, cookies, commit)
