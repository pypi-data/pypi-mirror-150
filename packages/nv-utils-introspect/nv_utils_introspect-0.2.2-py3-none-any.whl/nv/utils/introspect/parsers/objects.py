...
def get_scope_qualname(obj):
    definition_scope = getmodule(obj)
    return search_qualname(obj, definition_scope)
...
class ObjectParser:
    ...
    def get_full_qualname(self, obj):
        module_name, object_name = self.get_name_components(obj)
        return self.render_name(module_name, object_name)
