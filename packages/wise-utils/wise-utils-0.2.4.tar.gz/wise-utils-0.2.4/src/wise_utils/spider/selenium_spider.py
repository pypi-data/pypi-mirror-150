...
class SeleniumBaseSpider(BaseSpider):
    ...
    def find_elements_by_xpath(self, browser, rule: str):
        """通过xpath获取元素"""
        return self.__get_elements(browser, "xpath", rule)

    def find_elements_by_id(self, browser, rule: str):
        """通过id获取元素"""
        return self.__get_elements(browser, "id", rule)

    def wait_clickable_element(self, browser, by, rule: str, wait=10):
        """等待可点击的元素"""
        if by == 'id':
            return self.wait_clickable_element_by_id(browser, rule, wait)
        elif by == 'xpath':
            return self.wait_clickable_element_by_xpath(browser, rule, wait)
        return None
    ...
    def wait_located_element(self, browser, by, rule: str, wait=10):
        """等待元素"""
        if by == 'id':
            return self.wait_located_element_by_id(browser, rule, wait)
        elif by == 'xpath':
            return self.wait_located_element_by_xpath(browser, rule, wait)
        return None
    ...
    def wait_text_to_be_present(self, browser, by, rule: str, text, wait=10):
        """等待元素"""
        if by == 'id':
            return self.wait_text_to_be_present_by_id(browser, rule, text, wait)
        elif by == 'xpath':
            return self.wait_text_to_be_present_by_xpath(browser, rule, text, wait)
        return None
    ...
    def wait_ele_to_be_selected(self, browser, by, rule: str, wait=10):
        """等待选择框"""
        if by == 'id':
            return self.wait_ele_to_be_selected_by_id(browser, rule, wait)
        elif by == 'xpath':
            return self.wait_ele_to_be_selected_by_xpath(browser, rule, wait)
        return None
