...
from pants.base.build_environment import Git, get_git
...
class ReporterCallback(WorkunitsCallback):
    ...
    def _get_run_tracker_info(self, context: StreamingWorkunitContext) -> RunTrackerBuildInfo:
        ...
        _adjust_run_info_fields(run_info, run_tracker.goals, has_ended, scm=self._scm)
...
def _adjust_run_info_fields(run_info: dict, goals: list[str], has_ended: bool, scm: Git | None) -> None:
