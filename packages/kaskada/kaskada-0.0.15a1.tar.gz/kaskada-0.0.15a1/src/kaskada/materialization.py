...
def create_materialization(name: str, query: str, destination: RedisAIDestination, views: List[MaterializationView] = [], slice_filter: SliceFilter = None, client: Client = None) -> material_pb.CreateMaterializationResponse:
    """
