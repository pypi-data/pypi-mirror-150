...
setup(
    name="pyclicksign",
    version=pyclicksign.get_version(),
    license=pyclicksign.__licence__,
    description=("Implementação da api rest da plataforma de assinaturas "
                 "eletrônicas Clicksign."),
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/candango/pyclicksign",
    author=pyclicksign.get_author(),
    author_email=pyclicksign.get_author_email(),
