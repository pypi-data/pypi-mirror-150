...
class ActivityTrackerMiddleware:
    def __init__(self, get_response):
        ...
        self.DRF_ACTIVITY_TRACKER_SKIP_URL_NAME = ['history']
                ...
                if ipaddress.ip_address(ip).version == 4:
                    try:
                        country_name = pygeoip.GeoIP(
                            'drf_user_activity_tracker_mongodb/geo_databases/GeoIP.dat',
                    ...
                    try:
                        country_name = pygeoip.GeoIP(
                            'drf_user_activity_tracker_mongodb/geo_databases/GeoIPv6.dat',
                            pygeoip.MEMORY_CACHE).country_name_by_addr(ip)
                    except:
                        country_name = ''
                data = dict(
