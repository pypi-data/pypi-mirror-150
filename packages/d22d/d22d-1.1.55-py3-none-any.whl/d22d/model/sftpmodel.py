...
class SftpController:
    ...
    def _upload_file_to_some_where(
            ...
            check_ftp_file_same=True, append_offset=0, windows=1024 * 8 * 128):
        ...
        try:
            ...
            file_list = self.ftp.listdir(remote_path)
            remote_name = os.path.basename(remote_path)
            if (check_ftp_file_same and remote_name in file_list) or append_offset:
