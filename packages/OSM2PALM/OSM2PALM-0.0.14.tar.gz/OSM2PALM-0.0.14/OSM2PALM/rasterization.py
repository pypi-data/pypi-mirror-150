...
def process_building(lineO,lineL,domain,idxP,gdf,bHeight,x_mul,y_mul,x_start,y_start,bbox_cor,bldH,area,areaH):
    # poly.bounds
    nx = []
    ny = []
    xy = []
    ...
    [lineO,lineL] = entropy.count_edge(xy,lineO,lineL) # working
