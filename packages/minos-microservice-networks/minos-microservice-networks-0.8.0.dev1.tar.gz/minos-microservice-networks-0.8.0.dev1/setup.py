...
['minos',
 ...
 'minos.networks.brokers.publishers.transactional',
 'minos.networks.brokers.publishers.transactional.repositories',
 'minos.networks.brokers.publishers.transactional.repositories.database',
