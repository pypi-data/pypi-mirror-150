...
def cython_find_pyx_files(target_files:[str]=None) -> [str]:
...
def cython_build(target_files:[str], create_annotations:bool=True, include_numpy:bool=True):
...
def cython_clean(target_files:[str], keep_c_files:bool=False):
    """ Clean up all files """
