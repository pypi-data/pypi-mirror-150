...
class EnvironmentBuilder:
    ...
    def build(self, environment_name, allow_nightly_engine_builds=False, environment_tags=None):
        ...
        """
        self._environment.update({'name': environment_name, 'allowSnapshotEngineVersions': allow_nightly_engine_builds})
...
class DeploymentBuilder:
    ...
    def build(self, deployment_name, engine_type, engine_version,
...
class Deployments(CollectionModel):
    ...
    def _get_all_results_from_api(self, deployment_id=None, deployment_type=None, environment_id=None,
