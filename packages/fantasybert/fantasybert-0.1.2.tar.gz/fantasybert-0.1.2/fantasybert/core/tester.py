...
class Tester(object):
    def __init__(self,
        ...
        # check predict
        if (hasattr(self._model, 'predict') and callable(self._model.evaluate)) or \
            ...
            if isinstance(self._model, nn.DataParallel):
                ...
                self._predict_func = self._model.evaluate
                self._predict_func_wrapper = self._model.evaluate
        else:
