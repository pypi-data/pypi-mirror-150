...
def set_block_shuffle_args(batch_in_shuffle, sort_bs_num=None, sort_key=lambda x: len(x[0])):
    return {'batch_in_shuffle':batch_in_shuffle,
            'sort_bs_num': sort_bs_num,
            'sort_key':sort_key}
...
class TrainerState:
    ...
    save_path: str = field(default_factory=str)
