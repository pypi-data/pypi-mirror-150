...
def genmix(mixdb: dict,
    ...
    target_audios = build_target_audio_db(mixdb=mixdb_out, show_progress=show_progress)
    noise_audios = build_noise_audio_db(mixdb=mixdb_out, show_progress=show_progress)
    ...
    p_map(partial(_process_mixture,
                  mixdb=mixdb_out,
...
def _process_mixture(mixid: int,
                     mixdb: dict,
                     total_samples: int,
                     target_audios: list,
                     noise_audios: list,
