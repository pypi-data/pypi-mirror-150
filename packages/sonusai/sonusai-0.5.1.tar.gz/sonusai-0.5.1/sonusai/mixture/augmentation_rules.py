...
def get_augmentations(rules: Union[List[Dict], Dict], target: bool = False) -> list:
...
def expand_rules(out_rules: list, in_rule: dict, target: bool):
    """Expand rules."""
