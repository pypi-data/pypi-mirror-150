...
# Using the framework
#
# from idmhelper.dlthelper import TaskHelper
# TH=TaskHelper(spark=spark,storage="abfss://container@account.dfs.core.windows.net/im/mylocation")
# # define the pipeline array of tasks
# TaskHelper.generate(pipeline)
#
