...
class Player:
    ...
    def check_pk_commits(self, commits, failed_shares):
        ...
        when constructing the public key without said player's involvement.
    ...
    def complain(self, player):
        """
        Processes complains to player. If the player received more than t = k-1
        complaints, they are disqualified.

        :param player: Player who receives the complaint.
        :type player: Player
        """
