...
{	_nimCurFrame = getFrame();
	...
	TM__A82ybR1KJ9a3GOSp2XtOMmw_6.status = _setjmp(TM__A82ybR1KJ9a3GOSp2XtOMmw_6.context);
	...
	TM__A82ybR1KJ9a3GOSp2XtOMmw_7.status = _setjmp(TM__A82ybR1KJ9a3GOSp2XtOMmw_7.context);
