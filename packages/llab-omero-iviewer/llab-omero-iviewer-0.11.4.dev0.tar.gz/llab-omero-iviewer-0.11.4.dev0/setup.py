...
setup(name="llab-omero-iviewer",
      packages=find_packages(exclude=['ez_setup', 'ol3-viewer']),
      version=version,
      description="A Python plugin for OMERO.web on Athena",
      ...
      license='AGPL-3.0',
      url="https://github.com/barrettMCW/omero-iviewerLLAB/",
      download_url='https://github.com/barrettMCW/omero-iviewerLLAB/archive/v%s.tar.gz' % version,  # NOQA
