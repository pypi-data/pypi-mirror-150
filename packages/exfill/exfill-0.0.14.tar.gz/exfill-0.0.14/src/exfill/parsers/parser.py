...
class Posting():
    ...
    def __init__(self, posting_file, config):
        ...
        self.input_file_name = os.path.join(config['Parser']['input_dir'], posting_file)
    ...
    def get_company_details(self):
        ...
        compnay_details_fields = ['company_size', 'company_industry', 'hours', 'level']
        ...
        for section in company_details:
            ...
            if not len(section_split) == 2:
                err_msg = 'Company details section does not have exactly ' \
