...
def get_global_block_list_from_resolution_and_bb(processing_block_size, raster_resolution, bb):
    ...
    left_offset_h_blocks = math.ceil((180. + x_min_deg) / float(processing_block_size))
    # left_offset_h_blocks = (180. + x_min_deg) / float(processing_block_size)
    left_offset_h_pixels = left_offset_h_blocks * block_size
    top_offset_v_blocks = math.floor((90. + y_min_deg) / float(processing_block_size))
