...
def interpolate(
    ...
    Args:
        ...
        outside_fill (str, optional): Outside fill.
    ...
    if kind == "pointwise":
        ...
        raise UserTypeError('kind must be "pointwise" or "average"')
