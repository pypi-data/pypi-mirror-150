...
class UncertaintyDataQualityScoreAnalyser(DataQualityScoreAnalyser):
    ...
    def compute_score(
        ...
        Args:
            ...
            resample_rate (pd.Timedelta): Window aggregate
                Perform the uncertainty analysis on aggregate data. Default: 30 minutes
            emd_sift_thresh (float): Sifting threshold
            ...
            emd_max_num_imfs (int): Maximum number of components
            ...
            emd_error_tolerance (float): Energy tolerance
