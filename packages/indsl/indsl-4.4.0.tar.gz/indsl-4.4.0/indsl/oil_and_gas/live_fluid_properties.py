...
def retrieve_fluid_properties(
    ...
    Args:
        pressure (pandas.Series): Pressure time series
            Pressure sensor time series.
        temperature (pandas.Series): Temperature time series
            Temperature sensor time series.
        pvt_data (pandas.DataFrame): PVT data
        ...
        param (str): Fluid parameter of interest
            Fluid property to be estimated.
        interp_method (str): Method
