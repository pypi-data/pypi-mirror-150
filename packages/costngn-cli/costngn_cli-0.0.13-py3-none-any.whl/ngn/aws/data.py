...
def aws_main(company, nick, config_file,ce_enable:bool):
    ...
    for region in regions:
        ...
        for instance in instances:
            ...
            if inst['ihprice']is not None:
                ...
                inst['month_cost']= round(period *float(inst['ihprice']),4)
                rep['month_cost']+= inst['month_cost'] 
                #print('$$$$$$$$$ PERIOD',period, do_drop['month_cost'])            
                """
            else:            
    ...
    if ce_enable:    
        ...
        rep['month_cost']=response['ResultsByTime'][0]['Total']['UnblendedCost']['Amount']
