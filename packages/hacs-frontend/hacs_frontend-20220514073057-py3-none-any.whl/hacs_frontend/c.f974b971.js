import{a as o,H as s,e as t,t as e,$ as i,W as a,X as r,Y as c,Z as d,a0 as n,a1 as h,s as l,d as p,r as m,n as u}from"./main-2af83765.js";import{a as v}from"./c.7aca5ec5.js";import"./c.94b09f7e.js";import"./c.9be4b06e.js";import"./c.8613e225.js";import"./c.80f50c51.js";import"./c.d84e7514.js";import"./c.08c9f9b1.js";import"./c.f4ebe2a8.js";import"./c.e0e0bad7.js";import"./c.e61d287a.js";import"./c.d55610b5.js";import"./c.d608b0a2.js";let g=o([u("hacs-custom-repositories-dialog")],(function(o,s){return{F:class extends s{constructor(...s){super(...s),o(this)}},d:[{kind:"field",decorators:[t()],key:"_error",value:void 0},{kind:"field",decorators:[e()],key:"_progress",value:()=>!1},{kind:"field",decorators:[e()],key:"_addRepositoryData",value:()=>({category:void 0,repository:void 0})},{kind:"field",decorators:[e()],key:"_customRepositories",value:void 0},{kind:"method",key:"shouldUpdate",value:function(o){return o.has("narrow")||o.has("active")||o.has("_error")||o.has("_addRepositoryData")||o.has("_customRepositories")||o.has("_progress")}},{kind:"method",key:"render",value:function(){var o,s;if(!this.active)return i``;const t=[{name:"repository",selector:{text:{}}},{name:"category",selector:{select:{mode:"dropdown",options:this.hacs.configuration.categories.map((o=>({value:o,label:this.hacs.localize(`common.${o}`)})))}}}];return i`
      <hacs-dialog
        .active=${this.active}
        .hass=${this.hass}
      ...
      >
        <div class="content">
          <div class="list" ?narrow=${this.narrow}>
            ${null!==(o=this._error)&&void 0!==o&&o.message?i`<ha-alert alert-type="error" .rtl=${v(this.hass)}>
                  ${this._error.message}
                </ha-alert>`:""}
            ${null===(s=this._customRepositories)||void 0===s?void 0:s.filter((o=>this.hacs.configuration.categories.includes(o.category))).map((o=>i`<ha-settings-row
