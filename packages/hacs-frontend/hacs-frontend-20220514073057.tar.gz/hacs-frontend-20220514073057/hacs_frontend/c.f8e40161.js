        ...
        <div class="content">
          <div class="chips">
            ${this._repository.installed?h`
                ...
                `:""}
            ${i?i.map((i=>h`<hacs-link .url="https://github.com/${i}">
                    <ha-chip title="${this.hacs.localize("dialog_info.author")}" hasIcon>
                      <ha-svg-icon slot="icon" .path=${n}></ha-svg-icon>
                      @${i}
                    </ha-chip>
                  </hacs-link>`)):""}
            ${this._repository.downloads?h` <ha-chip hasIcon title="${this.hacs.localize("dialog_info.downloads")}">
          ...
          ${this._repository.updated_info?_.html(this._repository.additional_info||this.hacs.localize("dialog_info.no_info"),this._repository):h`
                <div class="loading">
                  <ha-circular-progress active size="large"></ha-circular-progress>
                </div>
              `}
        </div>
        ${!this._repository.installed&&this._repository.updated_info?h`
