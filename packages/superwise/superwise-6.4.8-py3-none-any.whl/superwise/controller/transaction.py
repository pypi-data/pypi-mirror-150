...
class TransactionController(BaseController):
    ...
    def log_from_s3(
        ...
        return self.log_file(
            file_path=superwise_file_path, _origin_path=file_path, version_id=version_id, model_id=model_id
        )

    def log_from_gcs(
        self, file_path: str, service_account: Dict, version_id: Optional[str] = None, model_id: Optional[str] = None
    ):
        """
        ### Description:
    ...
    def log_from_local_file(self, file_path: str, version_id: Optional[str] = None, model_id: Optional[str] = None):
        """
        ### Description:
        ...
        return self.log_file(
            file_path=superwise_file_path, _origin_path=f"file://{filename}", version_id=version_id, model_id=model_id
        )
    ...
    def log_file(
        ...
        params = {"file": file_path, "version_id": version_id, "model_id": model_id}
