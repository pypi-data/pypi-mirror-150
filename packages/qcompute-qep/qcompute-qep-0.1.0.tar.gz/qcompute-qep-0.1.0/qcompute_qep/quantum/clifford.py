...
.. [S15] Selinger, Peter. "Generators and relations for n-qubit Clifford operators." Logical Methods in Computer Science 11 (2015).
"""
...
class Clifford:
    ...
    **Examples**
    ...
    def matrix(self) -> np.ndarray:
        ...
        :return: The Clifford gate matrix
        """
    ...
    def __str__(self):
        ...
        """
        return circuit.print_circuit(self.circuit, show=False)
