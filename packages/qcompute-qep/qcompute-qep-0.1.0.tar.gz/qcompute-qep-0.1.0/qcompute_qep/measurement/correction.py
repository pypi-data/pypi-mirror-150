...
class Corrector(ABC):
    """
    Abstract interface `Corrector` for the Measurement Error Mitigation correction.
    Concrete measurement error correction methods must inherit this abstract class and implement the `correct` method.
    """
    def __init__(self,
                 qc: QComputer = None,
