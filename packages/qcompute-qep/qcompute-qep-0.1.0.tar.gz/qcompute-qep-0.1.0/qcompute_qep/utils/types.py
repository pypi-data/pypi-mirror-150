...
from QCompute.QPlatform import _metaBackendName

from qcompute_qep.exceptions.QEPError import ArgumentError

QProgram: Type[Union[QEnv, QuantumCircuit]] = Union[QCompute.QEnv, qiskit.QuantumCircuit]
r"""The Quantum Program data type in ``qcompute_qep``.
"""

QComputer: Type[Union[str, _metaBackendName, Backend]] = Union[str, _metaBackendName, Backend]
r"""The Quantum Computer data type in ``qcompute_qep``.
"""

__SUPPORTED_BACKENDS__ = ("LocalBaiduSim2", "CloudIoPCAS",
                          "Santiago", "Quito", "Vigo", "Yorktown", "Montreal",
                          "Aer_Simulator")
