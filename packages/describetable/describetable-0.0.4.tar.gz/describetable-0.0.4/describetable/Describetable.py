...
- data (a list of or a singular dash component, string or number; optional):
    ...
    the .describe() method."""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, data=Component.UNDEFINED, classAppendix=Component.UNDEFINED, buttonText=Component.UNDEFINED, buttonFloat=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'buttonFloat', 'buttonText', 'classAppendix', 'data']
        self._type = 'Describetable'
        self._namespace = 'describetable'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'buttonFloat', 'buttonText', 'classAppendix', 'data']
