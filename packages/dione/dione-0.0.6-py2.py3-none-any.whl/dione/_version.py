...
__all__ = ['__version__', '__updated__', '__title__', '__author__',
           '__license__', '__copyright__', '__documentation__']
...
#: Release date.
__updated__ = "2022-02-14 11:30:00"
...
__copyright__ = 'Copyright 2021-2022 European Commission (JRC)'

__documentation__ = 'http://JRCSTU.github.io/%s' % __title__
