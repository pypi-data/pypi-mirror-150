...
class AccessPolicyResponse(object):
    ...
    def creation_hooks(self, creation_hooks):
        ...
        :type: list[object]
        """
        if self.local_vars_configuration.client_side_validation and creation_hooks is None:  # noqa: E501
            raise ValueError("Invalid value for `creation_hooks`, must not be `None`")  # noqa: E501
