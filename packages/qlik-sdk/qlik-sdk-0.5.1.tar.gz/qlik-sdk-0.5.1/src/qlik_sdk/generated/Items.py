...
class ItemResultResponseBody:
    ...
    def get_collections(self, **queryParams) -> ItemsListItemCollectionsResponseBody:
        """
        ...
        **queryParams
        ...
        obj = ItemsListItemCollectionsResponseBody(**response.json())
        obj.auth = self.auth
        return obj

    def get_publisheditems(self, **queryParams) -> ItemsListItemCollectionsResponseBody:
        """
...
class Items:
    ...
    def get_items(self, max_items=10, **queryParams) -> ListObj[ItemResultResponseBody]:
        """
        ...
        **queryParams
        ...
        iter = self.auth.paginate_rest(
            path="/items", method="GET", params=queryParams, max_items=max_items
        )
        lst = ListObj()
        i = 0
        while i < min(max_items, 10):
            try:
                elem = iter.__next__()
                obj = ItemResultResponseBody(**elem)
                obj.auth = self.auth
                lst.append(obj)
                i += 1
        ...
        lst.iter = itertools.chain(lst, gen())
        return lst
