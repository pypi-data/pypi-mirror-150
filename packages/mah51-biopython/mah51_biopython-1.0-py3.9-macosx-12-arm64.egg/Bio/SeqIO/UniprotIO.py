                ...
                if element.attrib["type"] == "GO":
                    ...
                    for ref_element in element:
                        if ref_element.tag == NS + "property":
                            if ref_element.attrib["type"] == "term":
                                go_term["term"] = ref_element.attrib["value"]
                            if ref_element.attrib["type"] == "evidence":
                                go_term["evidence"] = ref_element.attrib["value"]

                    self.ParsedSeqRecord.go_terms.append(go_term)
