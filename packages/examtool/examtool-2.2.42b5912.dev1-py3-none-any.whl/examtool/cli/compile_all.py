...
def compile_all(
    ...
    if exam_data.get("watermark") and not do_twice:
        print("!!! WARNING: your exam seems to contain a watermark, but you're not using the --do-twice option;")
        print("!!! due to some underlying latex issues, this may cause your watermarks to not render properly,")
        print("!!! so we suggest using the --do-twice flag to ensure that your watermarks are rendered.")
