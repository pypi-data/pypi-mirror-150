...
def compute_extra_features(X,sampling):
    ...
    vm_norm_feature_extractor = signal_magnitude.EnergyFeature(X_vm, subwins=30)
    vm_norm_feature_extractor.get_energies()
    feature_list.append(vm_norm_feature_extractor.smv_energy_sum())
    feature_list.append(vm_norm_feature_extractor.smv_energy_var())
