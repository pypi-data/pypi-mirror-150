...
def __load_config():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "server" and sys.argv[2] == "create":
        return True
    elif len(sys.argv) > 1 and sys.argv[1] == "server" and sys.argv[2] == "enable":
        return True
        ...
        raise ServerConfigNotFound(servers=config.get_servers())
    return True
