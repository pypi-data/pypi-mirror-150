...
class CertoraBuildGenerator:
    ...
    def get_standard_json_filename(self, sdc_name: str) -> Path:
        std_json_path = self.config_path / f'{sdc_name}.standard.json.stdout'
        return std_json_path
    ...
    def standard_json(self, contract_file: Path, primary_contract_name: str, remappings: List[str]) -> Dict[str, Any]:
        """
        ...
        @return:
        """
        sources_dict = {str(contract_file): {"urls": [str(contract_file)]}}
    ...
    def collect_for_file(self,
        ...
        # Standard JSON
        input_for_solc = self.standard_json(Path(file_abs_path), primary_contract, remappings)
