...
<h3><img src="https://seleniumbase.io/img/green_logo.png" title="SeleniumBase" width="32" /> 9. Overriding the browser launcher </h3>
...
<h3><img src="https://seleniumbase.io/img/green_logo.png" title="SeleniumBase" width="32" /> 10. Using the browser launcher without BaseCase </h3>
...
(From <a href="https://github.com/seleniumbase/SeleniumBase/blob/master/examples/behave_bdd/realworld.feature">examples/behave_bdd/realworld.feature</a>)
...
(From <a href="https://github.com/seleniumbase/SeleniumBase/blob/master/examples/behave_bdd/environment.py">examples/behave_bdd/environment.py</a>)

Inside that file, you can either use ``BaseCase`` or a subclass of ``BaseCase``.
