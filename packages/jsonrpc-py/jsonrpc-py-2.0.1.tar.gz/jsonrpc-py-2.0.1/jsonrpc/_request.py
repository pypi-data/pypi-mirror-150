...
from ._utilities import Undefined, UndefinedType, boolean_sorter, make_hashable
...
class BatchRequest(BaseBatchRequest[Request | Error]):
    ...
    def __repr__(self) -> str:
        return f"<{self.__class__.__name__}({self._requests!r})>"
    ...
    def __iter__(self) -> Iterator[Request | Error]:
        return boolean_sorter(self._requests, lambda obj: isinstance(obj, Request) and obj.is_notification)
