...
class BaseMessage(object):
    ...
    def translate_message_class__to_handler_name(class_name):
        """
        This function turns the message class name to the equivelent function in the Message class.
        """
...
class WebSocketMessage(BaseMessage):
    ...
    def set_os_packages(self, **val):
        self.os_packages = val["os_packages"]
    ...
    def set_system_details(self, **details):
        details.pop("env")
        details.pop("machine")
        details.pop("os_release")
        details.pop("processor")
