...
def show_saturation_curves(df, df_adstock_saturation, coeffs, features, medias, saturation_type = 'hill'):
    df_saturation = saturation_to_dataset(df, df_adstock_saturation, coeffs, features, saturation_type=saturation_type)
