...
class Connection(object):
    def __init__(self, url="amqp://localhost:5672"):
        ...
        self.parameters.credentials = pika.PlainCredentials('guest','guest')
    ...
    def open(self, timeout=None):
        ...
        try:
            ...
            self.logger.info('Connection is Open:'+str(self.connection.is_open))
...
class Session(object):
    def __init__(self, connection, name, transactional, auto_ack):
        ...
        self.name = 'task'  # TODO do something useful with name
    ...
    def __init__(self, session, target):
        ...
        if self.name:
            try:
                ...
                session.connection.logger.info(e)
