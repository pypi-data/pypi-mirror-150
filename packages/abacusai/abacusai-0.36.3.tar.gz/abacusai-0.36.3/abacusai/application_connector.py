...
class ApplicationConnector(AbstractApiClass):
    ...
    def create_feature_group_from_git(self, branch_name: str, table_name: str, function_name: str, module_name: str, python_root: str = None, input_feature_groups: list = None, description: str = None, cpu_size: str = None, memory: int = None):
        """
        ...
        """
        return self.client.create_feature_group_from_git(self.application_connector_id, branch_name, table_name, function_name, module_name, python_root, input_feature_groups, description, cpu_size, memory)
