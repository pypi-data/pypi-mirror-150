...
analysis_date = datetime.datetime.now(tz=gettz('Asia/Kolkata')).strftime('%Y-%m-%d')
...
# Note - If Analysis_date_parameter is selected for any previous date, then analysis for it will be done with inventory of today, So Avoid using this parameter
