...
mktg_store_targets_today['target-sales'] = mktg_store_targets_today['target-sales'].astype(float)
mktg_store_targets_today['target-acq'] = mktg_store_targets_today['target-acq'].astype(float)
