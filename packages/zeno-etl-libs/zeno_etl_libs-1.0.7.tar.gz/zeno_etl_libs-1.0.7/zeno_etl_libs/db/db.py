...
#     """ implementing singleton design pattern for DB Class """
#
#     def __init__(self, env, secrets=None):
#         self.db_secrets = secrets
...
#         self.env = env
#         self.connection_string = "DRIVER={ODBC Driver 18 for SQL Server};SERVER=" + self.host + ";DATABASE=" + \
...
#             ssh_username='glue',
#             ssh_pkey='/Users/zeeshan/Desktop/id_rsa',
