...
def main(*argv):
    ...
    cherrypy.config.update(
        {"server.socket_host": args.address, "server.socket_port": args.port}
    )
    cherrypy.quickstart(ArchiveInterfaceGenerator(backend), "/", args.cp_config)
...
def cmd(argv=None):
    ...
    delete_parser.add_argument("FILES", nargs="+", help="delete the files")
