...
from dishpill import spaces
from dishpill.logger import deprecation
from dishpill.utils import seeding
from dishpill.utils.seeding import RandomNumberGenerator
...
class Env(Generic[ObsType, ActType]):
    """The main Dishpill class. It encapsulates an environment with
    ...
    def unwrapped(self) -> Env:
        ...
        Returns:
            dishpill.Env: The base non-wrapped dishpill.Env instance
        """
        return self
