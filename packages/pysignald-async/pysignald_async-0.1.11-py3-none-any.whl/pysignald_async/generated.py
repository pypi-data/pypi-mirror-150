...
@nested_dataclass
class DuplicateMessageErrorv1:
    timestamp: int = None
    message: str = None


@nested_dataclass
class UntrustedIdentityErrorv1:
    identifier: str = None
    message: str = None
...
@nested_dataclass
class ProtocolNoSessionErrorv1:
    sender: str = None
    timestamp: int = None
    message: str = None
...
@nested_dataclass
class ProtocolInvalidMessageErrorv1:
    sender: str = None
    timestamp: int = None
    message: str = None
    sender_device: int = None
...
@nested_dataclass
class ProtocolInvalidKeyIdErrorv1:
    sender: str = None
    timestamp: int = None
    message: str = None
    sender_device: int = None
...
@nested_dataclass
class NoSuchAccountErrorv1:
    account: str = None
    message: str = None


@nested_dataclass
class ServerNotFoundErrorv1:
    uuid: str = None
    message: str = None


@nested_dataclass
class InvalidProxyErrorv1:
    message: str = None


@nested_dataclass
class NoSendPermissionErrorv1:
    message: str = None


@nested_dataclass
class InvalidAttachmentErrorv1:
    filename: str = None
    message: str = None


@nested_dataclass
class InternalErrorv1:
    """
...
@nested_dataclass
class UnknownGroupErrorv1:
    message: str = None


@nested_dataclass
class RateLimitErrorv1:
    message: str = None


@nested_dataclass
class InvalidRecipientErrorv1:
    message: str = None


@nested_dataclass
class AttachmentTooLargeErrorv1:
    filename: str = None
    message: str = None


@nested_dataclass
class AuthorizationFailedErrorv1:
    """
...
@nested_dataclass
class OwnProfileKeyDoesNotExistErrorv1:
    message: str = None


@nested_dataclass
class GroupPatchNotAcceptedErrorv1:
    """
...
@nested_dataclass
class GroupVerificationErrorv1:
    message: str = None


@nested_dataclass
class InvalidGroupStateErrorv1:
    message: str = None
...
@nested_dataclass
class InvalidInviteURIErrorv1:
    message: str = None


@nested_dataclass
class GroupNotActiveErrorv1:
    message: str = None
...
@nested_dataclass
class ProfileUnavailableErrorv1:
    message: str = None
...
@nested_dataclass
class NoSuchSessionErrorv1:
    message: str = None


@nested_dataclass
class UserAlreadyExistsErrorv1:
    uuid: str = None
    message: str = None


@nested_dataclass
class ScanTimeoutErrorv1:
    message: str = None


@nested_dataclass
class CaptchaRequiredErrorv1:
    more: str = None
    message: str = None


@nested_dataclass
class AccountHasNoKeysErrorv1:
    message: str = None


@nested_dataclass
class AccountAlreadyVerifiedErrorv1:
    message: str = None


@nested_dataclass
class AccountLockedErrorv1:
    more: str = None
    message: str = None
...
@nested_dataclass
class FingerprintVersionMismatchErrorv1:
    message: str = None


@nested_dataclass
class UnknownIdentityKeyErrorv1:
    message: str = None


@nested_dataclass
class InvalidFingerprintErrorv1:
    message: str = None


@nested_dataclass
class InvalidGroupErrorv1:
    message: str = None
...
@nested_dataclass
class GroupLinkNotActiveErrorv1:
    message: str = None
