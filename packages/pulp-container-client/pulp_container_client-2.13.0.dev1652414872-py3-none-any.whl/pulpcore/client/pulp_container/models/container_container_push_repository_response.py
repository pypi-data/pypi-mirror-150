...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_created=None, name=None, retain_repo_versions=None, manifest_signing_service=None, pulp_href=None, latest_version_href=None, description=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
