...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, repository_version=None, repository=None, pulp_href=None, pulp_created=None, base_path=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
