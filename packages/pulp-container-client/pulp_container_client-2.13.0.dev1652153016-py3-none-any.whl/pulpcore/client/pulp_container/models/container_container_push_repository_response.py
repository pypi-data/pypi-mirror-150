...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, versions_href=None, description=None, retain_repo_versions=None, pulp_labels=None, pulp_href=None, manifest_signing_service=None, pulp_created=None, name=None, local_vars_configuration=None):  # noqa: E501
