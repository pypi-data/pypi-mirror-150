...
class ObjectToFetchType(TupleType):
    def __init__(self, name: str, **kwargs):
        super().__init__(name, **kwargs)

    def p_type(self, string: str) -> ObjectToFetch:
        return ObjectToFetch(super().p_type(string))
...
CH_TYPES_MAPPING = {
    ...
    "Tuple": TupleType,
    "ObjectToFetch": ObjectToFetchType,
    "Array": ArrayType,
