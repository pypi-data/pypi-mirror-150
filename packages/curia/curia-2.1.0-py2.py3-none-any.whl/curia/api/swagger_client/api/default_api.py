...
class DefaultApi(object):
    ...
    def create_many_base_timeline_code_filter_controller_timeline_code_filter(self, body, **kwargs):  # noqa: E501
        ...
        async_req :
            bool
        CreateManyTimelineCodeFilterDto :
            body: (required)
        body :
            param **kwargs:
        **kwargs :
    ...
    def create_many_base_timeline_feature_filter_controller_timeline_feature_filter(self, body, **kwargs):  # noqa: E501
        ...
        async_req :
            bool
        CreateManyTimelineFeatureFilterDto :
            body: (required)
        body :
            param **kwargs:
        **kwargs :
    ...
    def dataset_controller_upload(self, id, **kwargs):  # noqa: E501
        ...
        **kwargs :
        ...
        >>> thread = api.dataset_controller_upload(id, async_req=True)
        >>> result = thread.get()
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dataset_controller_upload_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.dataset_controller_upload_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def dataset_controller_upload_with_http_info(self, id, **kwargs):  # noqa: E501
        """dataset_controller_upload  # noqa: E501
        ...
        **kwargs :
        ...
        >>> thread = api.dataset_controller_upload_with_http_info(id, async_req=True)
        >>> result = thread.get()
        """
    ...
    def get_many_base_code_controller_code(self, **kwargs):  # noqa: E501
        ...
        async_req :
            bool
        list :
            str] fields: Selects resource fields. <a href=\"https://github.com/nestjsx/crud/wiki/Requests#select\" target=\"_blank\">Docs</a>
        str :
            s: Adds search condition. <a href=\"https://github.com/nestjsx/crud/wiki/Requests#search\" target=\"_blank\">Docs</a>
        list :
            str] filter: Adds filter condition. <a href=\"https://github.com/nestjsx/crud/wiki/Requests#filter\" target=\"_blank\">Docs</a>
        list :
            str] _or: Adds OR condition. <a href=\"https://github.com/nestjsx/crud/wiki/Requests#or\" target=\"_blank\">Docs</a>
        list :
            str] sort: Adds sort by field. <a href=\"https://github.com/nestjsx/crud/wiki/Requests#sort\" target=\"_blank\">Docs</a>
        list :
            str] join: Adds relational resources. <a href=\"https://github.com/nestjsx/crud/wiki/Requests#join\" target=\"_blank\">Docs</a>
        int :
