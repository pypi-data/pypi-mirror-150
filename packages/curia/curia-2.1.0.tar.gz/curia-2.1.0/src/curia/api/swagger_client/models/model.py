...
class Model(object):
    ...
    def __init__(self, id=None, name=None, type=None, outcome_type=None, aggregation_type=None, aggregation_column=None, feature_store=None, description=None, status=None, project_id=None, project=None, analysis_id=None, analysis=None, batch_id=None, batch=None, cohorts=None, model_jobs=None, user_favorites=None, model_datasets=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, archived_at=None, version=None):  # noqa: E501
