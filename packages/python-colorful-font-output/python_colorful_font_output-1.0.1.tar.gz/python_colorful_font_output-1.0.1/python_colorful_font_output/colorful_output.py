...
"""colorful_output.py"""
"""
此.py文件名为colorful_output.py（42133字符、735行，1.0.0~1.0.1的更新增加9522字符）
...
def screen_loop(cartoon_num, str_ob, random_sleep=0, ranges=100, use='%',
                                                times=0.2, con=1, con_ob="Successfully installed the module."):
...
class Help:                           # 因为我在网站上没写功能，所以写在着里
    ...
    def ask_the_module_questions(self):
        ...
        if answer == "Run the module's tips":                        # 一些提示
            ...
            |    |    ranges=100, use='%', times=0.2, con=1, con_ob="Successfully installed the module.")
            ...
            |    |    |____(Link)The 1~9 numbers' defined:
            |    |                    [': ','··',' :','..'],                      # 1 recommend
            |    |                    ['\\','/','—'],                            # 2
            |    |                    ['<','^','>','v'],                         # 3
            |    |                    [':.',':·','·:','.:'],                     # 4
            ...
            python-colorful-font-output               1.0.1(This version)
            ...
            python-colorful-font-output   2022.05.10 17:45       1.0.1(This version)
