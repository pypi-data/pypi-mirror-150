...
from .aggregate import Perimeter, Reference, openfisca_variables
...
liste_des_variables_csg_2019 = pd.read_csv(
    config.get("DATASETS") + "20220427-ExtractionAll/data/agregats_POTE_2019.csv"
)
liste_des_variables_revenus_2019 = pd.read_csv(
    config.get("DATASETS")
    + "20220427-ExtractionAll/data/agregats_POTE_revenus_rici_2019.csv"
)
