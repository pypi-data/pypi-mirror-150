...
from NER_abstract import NER_abstract
...
class NER_CRF_dictionaries(NER_abstract):
    ...
    """
    def __init__(self):
        filename = 'src/mask_framework_lib/Models/crf_dict_model.sav'
        ...
        country_file = open("src/mask_framework_lib/Dictionaries/Countries.txt",'r', encoding='utf-8')
        self.dictionary_country = country_file.readlines()
        self.dictionary_country = set([line[:-1] for line in self.dictionary_country])
        city_file = open("src/mask_framework_lib/Dictionaries/Cities.txt",'r', encoding='utf-8')
        self.dictionary_city = city_file.readlines()
        self.dictionary_city = set([line[:-1] for line in self.dictionary_city])

        first_name_file = open("src/mask_framework_lib/Dictionaries/dictionary_first_names.txt", 'r', encoding='utf-8')
        ...
        surname_file = open("src/mask_framework_lib/Dictionaries/dictionary_surnames.txt", 'r', encoding='utf-8')
        ...
        with open('src/mask_framework_lib/Dictionaries/job_title_dictionary.csv', encoding='utf-8') as csv_file:
    ...
    def save(self,model_path):
        ...
        filename = "src/mask_framework_lib/Models/"+model_path+"1.sav"
        print(filename)
