...
class WSItem(GeneralEnum):
    ...
    WORKSPACE                        = (0,  WSItemType.OTHER, 'Workspace', None, False, False, 0b10001)
    ...
    DATASET                          = (3,  WSItemType.OTHER, 'Datasets', None, False, False, 0b10011)
...
class WSComparer(AbstractObject):
    ...
    def _process_workspace_data(self):
        ...
        if len(df_common) == 0:
            ...
            names_l = df[index_1]['name'].values()
        ...
        with Timer() as t:
            ...
            for ds_name in common_dataset_names:
                ...
                if not same_definition:
                    df.loc[dataset_name, ['category']] = "redefined"
