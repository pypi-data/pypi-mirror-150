...
def dualm(v, env):
    ...
    pvnp, pv = convert_py_float_to_cffi( v)
    pout_wnp, pout_w = create_float_zeros_as_CFFI_double( env.n)
...
def Interaction(v, env):
    ...
    pout_Mobnp, pout_Mob = create_float_zeros_as_CFFI_double( env.m)
    pvnp, pv = convert_py_float_to_cffi( v)
    fm.py_Interaction( pout_Mobpv, env)
    return pout_Mobnp
...
def InteractionB(v, env):
    ...
    pout_Mobnp, pout_Mob = create_float_zeros_as_CFFI_double( env.m)
    pvnp, pv = convert_py_float_to_cffi( v)
    fm.py_InteractionB( pout_Mobpv, env)
    return pout_Mobnp
...
def InteractionMob(v, env):
    ...
    pout_Mobnp, pout_Mob = create_float_zeros_as_CFFI_double( env.m)
    pvnp, pv = convert_py_float_to_cffi( v)
    fm.py_InteractionMob( pout_Mobpv, env)
    return pout_Mobnp
...
def Shapley2addMob(v, n):
    ...
    pvnp, pv = convert_py_float_to_cffi( v)
    pout_xnp, pout_x = create_float_zeros_as_CFFI_double( env.m)
