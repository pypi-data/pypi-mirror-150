...
Mob = [0.0,0.3,0.5,-0.2,0.4,0.1,-0.2,0.1]
kadd = 2
dual = pyw.dualMobKadd(kadd, Mob, env)
print( "Mob: ", Mob)
print( "kadd: ", kadd)
print( "dual: ", dual)
...
array_size = 0
vv = []
# array_size, vv = pyw.generate_fm_minplus(num, n, kint, markov, option, K, env)
print( "num: ", num)
print( "n: ", n)
print( "kint: ", kint)
print( "markov: ", markov)
...
num = 10
n = 6
# array_size, vv = pyw.generate_fm_2additive_convex(num, n)
print( "num: ", num)
print( "n: ", n)
print( "array_size: ", array_size)
print( "vv: ", vv)
...
num = 10
n = 6
# array_size, vv = pyw.generate_fm_2additive_convex_withsomeindependent(num, n)
print( "num: ", num)
print( "n: ", n)
print( "array_size: ", array_size)
print( "vv: ", vv)
