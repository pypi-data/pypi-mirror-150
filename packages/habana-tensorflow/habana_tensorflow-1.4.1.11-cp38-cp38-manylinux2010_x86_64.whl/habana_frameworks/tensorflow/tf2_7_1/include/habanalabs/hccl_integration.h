...
hcclResult_t hcclxAcquireCollectiveStream(int device_id, hcclStream_t* stream_handle);

hcclResult_t hcclxReleaseCollectiveStream(hcclStream_t stream_handle);
...
hcclResult_t hcclxPrepareStream(hcclStream_t stream_handle, void** input_addresses_array_ptr, size_t array_length);

hcclResult_t hcclxSubmitEvents(hcclStream_t stream_handle, void** input_addresses_array_ptr, size_t array_length,
                               hcclxCallback_t cleanup_callback, hcclxCallbackCookie_t callback_cookie);

hcclResult_t hcclxStreamSynchronize(hcclStream_t stream_handle);
