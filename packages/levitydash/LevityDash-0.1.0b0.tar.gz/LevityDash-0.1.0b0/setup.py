...
{'': ['*'],
 'LevityDash': ['example-config/config.ini',
                ...
                'example-config/plugins/WeatherFlow.ini',
                'example-config/plugins/WeatherFlow.ini',
                'example-config/plugins/plugins.ini',
                'example-config/plugins/plugins.ini',
...
extras_require = \
{':platform_machine != "aarch64"': ['PySide2>=5.15.2,<6.0.0']}
...
setup_kwargs = {
    'name': 'levitydash',
    'version': '0.1.0b0',
    'description': 'A lightweight, desktop native, multi-source dashboard for macOS, Windows and Linux',
