...
#----------------------------------------------------------------------------------------------------------------------#
    ...
    try:
        ...
        #Creating database
        mydb1.execute("CREATE DATABASE IF NOT EXISTS sisvcs")
        condb = mysql.connect(host = "localhost", user="root", password = "", database="sisvcs")
        mydb = condb.cursor(buffered = True)

        mydb.execute("CREATE TABLE IF NOT EXISTS admin(id int auto_increment primary key, username varchar(20), password varchar(20))")
        mydb.execute("CREATE TABLE IF NOT EXISTS student(id int auto_increment primary key, student_id varchar(20), fullname varchar(255), age int(6), gender varchar(255), department varchar(255), course varchar(255), address varchar(255), mobile_no varchar(255), batch_number varchar(255), vac_manufacturer varchar(255), dose_number varchar(255))")
...
#----------------------------------------------------------------------------------------------------------------------#        
        ...
        style.configure('Submit.TButton', background='#6d0e0e', foreground='white', borderwidth=0, width=13,  font=('Open Sans', 12))
        style.map('Submit.TButton', foreground=[('active', 'white')], background=[('active', '#6d0e0e')])
 
#----------------------------------------------------------------------------------------------------------------------#       
        #Login Link Style
        style.configure('Login_link.TButton', background='white', foreground='#6d0e0e', borderwidth=0, width=8, font=('Open Sans', 8))
...
#----------------------------------------------------------------------------------------------------------------------#  
        #FULL NAME LABEL
        text= Label(reg_frame, text="FULL NAME",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        fullname = Entry(reg_frame, width=43,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
...
#----------------------------------------------------------------------------------------------------------------------#
        #STUDENT ID LABEL
        text = Label(reg_frame, text="STUDENT ID",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        student_id = Entry(reg_frame, width=43,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        frames=Frame(reg_frame, width=303, height=2, bg='black')
...
#----------------------------------------------------------------------------------------------------------------------#       
#       #AGE LABEL
        text = Label(reg_frame, text="AGE",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        age = Entry(reg_frame, width=18,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
 ...
 #----------------------------------------------------------------------------------------------------------------------#       
        #GENDER LABEL
        text = Label(reg_frame, text="GENDER",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        gender = Entry (reg_frame, width=23,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
...
#----------------------------------------------------------------------------------------------------------------------#        
        #DETAPARTMENT LABEL
        text = Label(reg_frame, text="DEPARTMENT",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        department = Entry(reg_frame, width=42,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
 ...
 #----------------------------------------------------------------------------------------------------------------------#       
        #COURSE LABEL
        text = Label(reg_frame, text="COURSE",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        course = Entry(reg_frame, width=46,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
 ...
 #----------------------------------------------------------------------------------------------------------------------#       
        #ADDRESS LABEL
        text = Label(reg_frame, text="ADDRESS",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        address = Entry(reg_frame, width=46,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        frames = Frame(reg_frame, width=323, height=2, bg='black')
...
#----------------------------------------------------------------------------------------------------------------------#        
        #MOBILE NUMBER LABEL 
        text = Label(reg_frame, text="MOBILE NUMBER",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5' )
        mobile_no = Entry(reg_frame, width=39,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
...
#----------------------------------------------------------------------------------------------------------------------# 
        #BATCH NUMBER
        text= Label(vac_frame, text="BATCH NUMBER",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        batch_number = Entry(vac_frame, width=40,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
...
#----------------------------------------------------------------------------------------------------------------------# 
        #BRAND/MANUFACTURER
        text= Label(vac_frame, text="BRAND/MANUFACTURER",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        vac_manufacturer = Entry(vac_frame, width=33,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
...
#----------------------------------------------------------------------------------------------------------------------# 
        #DOSE NUMBER
        text= Label(vac_frame, text="DOSE NUMBER",fg='black', font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        dose_number = Entry(vac_frame, width=40,fg='black',border=0, font=('Open Sans', 8, 'bold'), bg='#f5f5f5')
        frames=Frame(vac_frame, width=282, height=2, bg='black')
...
#----------------------------------------------------------------------------------------------------------------------#
 ...
 #----------------------------------------------------------------------------------------------------------------------#       
        #Data buttons Style
        style.configure('Data.TButton', background='#6d0e0e', foreground='white', borderwidth=0, width=11,  font=('Open Sans', 13, ))
...
#@JOHN LLOYD D. DE SAPE
        ...
        ##d9d9d9
        fname1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        fname1.place(x=35, y=111)
        
        stuid1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        stuid1.place(x=34, y=159)
        
        Age1 = Entry(frame, width=13,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        Age1.place(x=36, y=203)
        
        Gender1 = Entry(frame, width=18, border=0,font=('Open Sans', 10), bg='#f5f5f5')
        Gender1.place(x=149, y=203)
        
        
        dept1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        dept1.place(x=34, y=248)
        
        Course1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        Course1.place(x=34, y=294)
        
        add1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        add1.place(x=34, y=341)
        
        mobile1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        mobile1.place(x=34, y=387)
        
        
        batch1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        batch1.place(x=34, y=433)
        
        vacm1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
        vacm1.place(x=34, y=480)

        dosen1 = Entry(frame, width=34,border=0, font=('Open Sans', 10), bg='#f5f5f5')
...
"""     
        ...
        search_entry= Entry(frame,textvariable=var_search, width=27,border=0, font=('Open Sans', 12), bg='#f5f5f5')
        search_entry.place(x=647, y=117)
...
#----------------------------------------------------------------------------------------------------------------------#
    ...
    def login(self):
        ...
        #Back Link Style
        style.configure('Back.TButton', background='white', foreground='#6d0e0e', borderwidth=0, width=8, font=('Open Sans', 8))
...
#@JOHN LLOYD D. DE SAPE
        ...
        #USERNAME LABEL
        text = Label(login_frame,text="USERNAME",fg='black', font=('Open Sans', 15, 'bold'), bg='#f5f5f5')
        username = Entry(login_frame, width=30,fg='black', border=0,font=('Open Sans', 12, ), bg='#f5f5f5')
        ...
        #PASSWORD LABEL
        text = Label(login_frame,text="PASSWORD",fg='black', font=('Open Sans', 15, 'bold'), bg='#f5f5f5')
        password = Entry(login_frame, width=30,fg='black', border=0,show='*',font=('Open Sans', 12, ), bg='#f5f5f5')
