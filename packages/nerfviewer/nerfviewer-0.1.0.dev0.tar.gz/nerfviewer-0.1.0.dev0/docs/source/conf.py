...
# -*- coding: utf-8 -*-
#
# nerfviewer documentation build configuration file
#
...
project = 'nerfviewer'
copyright = '2022, Dylan Wootton and Josh Pollock'
...
_version_py = os.path.join(repo, 'nerfviewer', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'nerfviewerdoc'
...
latex_documents = [
    (master_doc, 'nerfviewer.tex', 'nerfviewer Documentation',
     'Dylan Wootton and Josh Pollock', 'manual'),
]
