...
class VecSS:
    def __init__(self, file="small_cDNA_Sequences_pbmc_1k_v2_S1_L002_R2_001.fastq",length = 10000,encoding="one-hot-encoding",bits=8):
        ...
        self.encoder = encoder.Encoder(bits=self.bits, encoding=self.encoding)
