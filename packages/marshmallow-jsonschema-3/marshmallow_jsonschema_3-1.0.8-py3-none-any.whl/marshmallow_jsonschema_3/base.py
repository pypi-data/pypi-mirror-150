...
PY_TO_JSON_TYPES_MAP = {
    ...
    bool: {"type": "boolean"},
    Enum: {"type": "string"},
    callable: {"type": "any"}  # fields.Function can return anything.
}
...
MARSHMALLOW_TO_PY_TYPES_PAIRS = [
    ...
    (fields.Constant, int),
    (fields.Function, callable),  # Can resolve to anything, but we cannot prove return type!
...
class JSONSchema(Schema):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.use_easy_enum = kwargs.pop("use_easy_enum", False)
        ...
        for validator in field.validators:
            if validator.__class__ in FIELD_VALIDATORS:
                schema = FIELD_VALIDATORS[validator.__class__](
                    ...
                    use_easy_enum=self.use_easy_enum
                )
            else:
                base_class = getattr(
    ...
    def _from_nested_schema(self, obj, field):
        ...
        if isclass(nested) and issubclass(nested, Schema):
            ...
            # Resolve fields.Function nested fields!
