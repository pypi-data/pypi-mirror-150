...
const file = "Users/aliabid/projects/gradio/ui/packages/carousel/src/Carousel.svelte";
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(path0, "class", "s-FX_YCCs3JwOv");
			add_location(path0, file, 52, 4, 1312);
			attr_dev(svg0, "class", "caret text-xs fill-current s-FX_YCCs3JwOv");
			...
			attr_dev(button0, "class", "flex items-center justify-center h-6 w-6 hover:text-orange-500 s-FX_YCCs3JwOv");
			add_location(button0, file, 42, 2, 1078);
			attr_dev(div0, "class", "carousel_index text-center font-semibold s-FX_YCCs3JwOv");
			...
			attr_dev(path1, "class", "s-FX_YCCs3JwOv");
			add_location(path1, file, 70, 4, 2184);
			attr_dev(svg1, "class", "caret text-xs fill-current scale-x-[-1] s-FX_YCCs3JwOv");
			...
			attr_dev(button1, "class", "flex items-center justify-center h-6 w-6 hover:text-orange-500 s-FX_YCCs3JwOv");
			add_location(button1, file, 60, 2, 1936);
			attr_dev(div1, "class", "carousel-control flex gap-4 justify-center items-center pt-2 text-sm s-FX_YCCs3JwOv");
			add_location(div1, file, 39, 1, 989);
			attr_dev(div2, "class", "output-carousel flex flex-col relative s-FX_YCCs3JwOv");
