...
const file$2 = "Users/aliabid/projects/gradio/ui/packages/icons/src/TextHighlight.svelte";
...
const file$1 = "Users/aliabid/projects/gradio/ui/packages/highlighted-text/src/HighlightedText.svelte";
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "textfield p-2 bg-white dark:bg-gray-800 rounded box-border max-w-full break-word leading-7 s-vBZVkX74Ywm4");
...
function create_if_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "textfield bg-white dark:bg-transparent rounded-sm text-sm box-border max-w-full break-word leading-7 s-vBZVkX74Ywm4");
...
function create_if_block_3(ctx) {
	...
	const block = {
		c: function create() {
			...
			span2 = element("span");
			span2.textContent = "+1";
			attr_dev(span0, "class", "s-vBZVkX74Ywm4");
			add_location(span0, file$1, 131, 3, 4059);
			attr_dev(span1, "class", "s-vBZVkX74Ywm4");
			add_location(span1, file$1, 132, 3, 4078);
			attr_dev(span2, "class", "s-vBZVkX74Ywm4");
			add_location(span2, file$1, 133, 3, 4096);
			attr_dev(div, "class", "color_legend flex px-2 py-1 justify-between rounded mb-3 font-semibold s-vBZVkX74Ywm4");
...
function create_each_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			attr_dev(span0, "class", "text dark:text-white s-vBZVkX74Ywm4");
			add_location(span0, file$1, 146, 4, 4486);
			attr_dev(span1, "class", "textspan p-1 mr-0.5 bg-opacity-20 dark:bg-opacity-80 rounded-sm s-vBZVkX74Ywm4");
...
function create_if_block_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "category-legend flex flex-wrap gap-1 mb-2 text-black s-vBZVkX74Ywm4");
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t0 = text(t0_value);
			t1 = space();
			attr_dev(div, "class", "category-label px-2 rounded-sm font-semibold cursor-pointer s-vBZVkX74Ywm4");
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		c: function create() {
			span = element("span");
			t = text(t_value);
			attr_dev(span, "class", "label mr-[-4px] font-bold uppercase text-xs inline-category text-white rounded-sm px-[0.325rem] mt-[0.05rem] py-[0.05rem] transition-colors s-vBZVkX74Ywm4");
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (if_block) if_block.c();
			t2 = space();
			attr_dev(span0, "class", "text  s-vBZVkX74Ywm4");
			add_location(span0, file$1, 110, 4, 3310);
			attr_dev(span1, "class", "textspan rounded-sm px-1 transition-colors text-black pb-[0.225rem] pt-[0.15rem] s-vBZVkX74Ywm4");
