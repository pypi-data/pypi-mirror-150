import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, Z as create_slot, v as validate_slots, Y as getContext, P as validate_store, Q as component_subscribe, J as onDestroy, h as element, k as text, b as attr_dev, c as add_location, e as insert_dev, f as append_dev, m as set_data_dev, g as detach_dev, w as space, t as toggle_class, _ as update_slot_base, $ as get_all_dirty_from_scope, a0 as get_slot_changes, D as transition_in, E as transition_out, B as create_component, C as mount_component, F as destroy_component } from './index.ac9abe4c.js';
import { a as CAROUSEL } from './CarouselItem.svelte_svelte_type_style_lang.e7f78b02.js';

/* Users/aliabid/projects/gradio/ui/packages/carousel/src/CarouselItem.svelte generated by Svelte v3.47.0 */
const file = "Users/aliabid/projects/gradio/ui/packages/carousel/src/CarouselItem.svelte";
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			div = element("div");
			t = text(/*label*/ ctx[0]);
			attr_dev(div, "class", "absolute left-0 top-0 py-1 px-2 rounded-br-lg shadow-sm text-xs text-gray-500 flex items-center pointer-events-none bg-white z-20 dark:bg-gray-800 s-666OXAkDZJQx");
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "carousel-item hidden component min-h-[200px] border rounded-lg overflow-hidden relative s-666OXAkDZJQx");
