...
class NssSource(object):
    ...
    def _fields(self):
        base_orbital_fields = ["ra", "dec", "parallax", "pmra", "pmdec",
        ...
        if star_type == "Orbital":
            others_fields = ["eccentricity", "period", "t_periastron"]
        elif star_type.startswith("Orbital"):
            others_fields = ["period", "eccentricity", "t_periastron"]
        elif star_type.startswith("SB"):
            others_fields = ["period", "center_of_mass_velocity",
                             "semi_amplitude_primary", "semi_amplitude_secondary", "eccentricity",
                             "arg_periastron", "t_periastron"]
        elif star_type == "AstroSpectroSB1":
            others_fields = ["center_of_mass_velocity",
                             "eccentricity", "period", "t_periastron"]
        elif star_type.startswith("Eclipsing"):
            others_fields = ["t_periastron", "center_of_mass_velocity",
        ...
        values_names = base_orbital_fields + others_fields
