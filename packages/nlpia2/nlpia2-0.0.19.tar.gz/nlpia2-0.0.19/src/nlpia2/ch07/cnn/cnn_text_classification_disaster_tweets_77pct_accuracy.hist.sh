 8365  tar xvz --strip-component=1 --file=dist/$TARFILE --wildcards '*/setup.py'
 8366  ls -hal
 8367  rm -rf nlpia2-0.0.17/
 8368  tar xvz --strip-component=1 --file=dist/$TARFILE --wildcards '*/setup.py'
 8369  ls -hal
 8370  rm setup.py
 8371  rm -rf nlpia2-0.0.17/
 8372  ls -hal
 8373  rm -r .nlpia-data
 8374  source scripts/install_editable.sh
 8375  grep -E 'name\s*=\s*' pyproject.toml
 8376  grep -E 'name\s*=\s*[\'"]' pyproject.toml
 8377  grep -E 'name\s*=\s*["'"']" pyproject.toml
 8378  grep -E 'name\s*=\s*[\'"]' pyproject.toml
 8379  grep -E 'name\s*=\s*["]' pyproject.toml
 8380  grep -E 'name\s*=\s*["'"']" pyproject.toml
 8381  grep -E 'name\s*=\s*["'"'].*['"'"']' pyproject.toml
 8382  grep -E 'name\s*=\s*["'"'].*['"'"]' pyproject.toml
 8383  man grep extract substring
 8384  source scripts/install_editable.sh
 8385  ls -hal
 8386  more LICENSE
 ...
 8463  python src/nlpia2/ch07/cnn/main.py --tokenizer=tokenize_re --case_sensitive=1 --num_stopwords=10 --strides=[2,2,2,2] --kernel_lengths=[2,3,4,5] --vocab_size=4000 --epochs=14 --test_size=.05 --embedding_size=64 --dropout_portion=.1
