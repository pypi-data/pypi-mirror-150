...
class GT:
    def __init__(self, DM_req, size_of_clusters, number_of_depots, location, color_list):
        self.DM_req = DM_req
    ...
    def draw_cluster_result(self, cluster_result, center_point=[], GT_between_cluster=[], in_out_original=[],
                            giant_tour=[]):
        number_of_depots = self.number_of_depots
