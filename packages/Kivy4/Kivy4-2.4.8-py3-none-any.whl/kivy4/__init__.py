import time, pyperclip, os, darkdetect, threading, winshell
...
'''
    ...
    def create_shortcut(self, source=__file__, target=None, name=None, only_exe=True):

        if not only_exe and source.endswith('.exe'):
