...
class PricingRecorder:
    ...
    def record(
        ...
        if frequency_tick and no_duration and ticks_1:
        ...
        elif frequency_tick and no_duration and ticks_not_1:

            if not isinstance(self._ohlc_builder, Ticks_OHLCBuilder):
                self._ohlc_builder = Ticks_OHLCBuilder(
        ...
        elif frequency_tick and duration and ticks_1:
        ...
        elif frequency_tick and duration and ticks_not_1:
        ...
        elif frequency and no_duration and ticks_1:

            if not isinstance(self._ohlc_builder, OHLCBuilder):
                self._ohlc_builder = OHLCBuilder(
                    self._frequency, self._stream.universe, self._stream.fields
                )
        ...
        elif frequency and duration and ticks_1:
