...
def add_histograms(writer, net, global_step=0):
    ...
    writer.add_histogram('dec_lstm_0', net.dec_lstm.all_weights[0][0], global_step=global_step)
    writer.add_histogram('dec_lstm_1', net.dec_lstm.all_weights[0][1], global_step=global_step)
    writer.add_histogram('dec_lstm_2', net.dec_lstm.all_weights[0][2], global_step=global_step)
    writer.add_histogram('dec_lstm_3', net.dec_lstm.all_weights[0][3], global_step=global_step)
    writer.add_histogram('dyn_emb', net.dyn_emb.weight, global_step=global_step)
    writer.add_histogram('enc_lstm_0', net.enc_lstm.all_weights[0][0], global_step=global_step)
    writer.add_histogram('enc_lstm_1', net.enc_lstm.all_weights[0][1], global_step=global_step)
    writer.add_histogram('enc_lstm_2', net.enc_lstm.all_weights[0][2], global_step=global_step)
    writer.add_histogram('enc_lstm_3', net.enc_lstm.all_weights[0][3], global_step=global_step)
