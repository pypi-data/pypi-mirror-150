...
def _validate_feature_timestamps(
    ...
    if feature_data_time_limits:
        ...
        # If the UDF was already registered by the previous calls, do nothing.
        #
        ...
        all_udfs = spark.catalog.listFunctions()
        if not any([udf.name == TECTON_FEATURE_TIMESTAMP_VALIDATOR for udf in all_udfs]):
