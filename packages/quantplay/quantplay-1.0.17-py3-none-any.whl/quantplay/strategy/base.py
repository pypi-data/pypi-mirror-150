...
class QuantplayAlgorithm:
    ...
    def validate(self):
        ...
        if not hasattr(self, "exit_time"):
            raise Exception("Strategy must have 'exit_time' attribute")
    ...
    def backtest(self, **kwargs):
        ...
        backtesting.load_data(list(trades.tradingsymbol.unique()))
        ...
        results, trades_res = backtesting.evaluate_performance(trades)
