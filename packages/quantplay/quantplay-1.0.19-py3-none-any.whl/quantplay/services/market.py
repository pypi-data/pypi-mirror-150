...
class Market:
    ...
    def __init__(self):
        ...
        self.nse_equity_path = "/NSE_EQ/"
        self.nse_opt_path = "/NSE_OPT/"
        self.nse_fut_path = "/NSE_FUT/"
    ...
    def data(self, interval=None, symbols_by_security_type=None, **kwargs):
        ...
        for security_type, symbols in symbols_by_security_type.items():
            ...
            print(f"Loading {security_type} data for {len(set(symbols))} symbols")
            df = DataUtils.load_data_using_pandas(
                stocks=symbols,
                interval=interval,
    ...
    def get_trades(self, data, entry_time_regex):
        return data[
