...
class StrategyReport:
    ...
    def print_portfolio(portfolio):
        print("\n\n")
        print("POINT_DIFF ANALYSIS")
        print(
            portfolio.groupby(["day_of_week"]).point_diff.describe(
        ...
        print(
            portfolio.groupby(["day_of_week"]).profit.describe(
                percentiles=[0.25, 0.5, 0.75, 0.95]
            )
        )

        print("\n\n")
        print("OPTION_TYPE ANALYSIS")
        print(portfolio.groupby(["option_type"]).point_diff.describe())

        VisualReport.display_profit_report(portfolio, groupby="M")
        VisualReport.display_profit_report(portfolio, groupby="Y")
        VisualReport.display_profit_report(portfolio, groupby="W")
        VisualReport.display_profit_report_by_symbol(portfolio)
        VisualReport.display_balance_report(portfolio)
