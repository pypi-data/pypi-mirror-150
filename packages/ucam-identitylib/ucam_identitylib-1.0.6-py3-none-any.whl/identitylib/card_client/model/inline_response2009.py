...
def lazy_import():
    ...
    globals()['InlineResponse2009Details'] = InlineResponse2009Details
...
class InlineResponse2009(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'details': ([InlineResponse2009Details],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            details ([InlineResponse2009Details]): [optional]  # noqa: E501
        """
