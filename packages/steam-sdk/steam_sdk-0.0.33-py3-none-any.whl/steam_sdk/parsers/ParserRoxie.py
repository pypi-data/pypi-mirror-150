...
def get_conductor_corners(roxie_data: pd.APIdata):
        ...
        for halfTurn_nr, halfTurn in block.half_turns.items():
            ...
            for strand_gr_nr, strand_gr in halfTurn.strand_groups.items():
                for strand_nr, strand in strand_gr.strand_positions.items():
                    ...
                    strand_to_halfTurn.append(idx_half_turn)

    return x_insulated, y_insulated, x_bare, y_bare, i_conductor, x_strand, y_strand, i_strand, strand_to_halfTurn


def get_conductor_corners_old(roxie_data: pd.APIdata):
    """ Returns conductor corner positions (insulated and bare)  and conductor currents in list form """
    x_insulated = []
    y_insulated = []
    x_bare = []
