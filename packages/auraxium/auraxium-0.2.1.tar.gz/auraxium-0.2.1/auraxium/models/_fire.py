...
class FireModeData(RESTPayload):
    ...
    fire_mode_id: int
    fire_mode_type_id: Optional[int] = None
    ...
    fire_ammo_per_shot: Optional[int] = None
    fire_auto_fire_ms: Optional[int] = None
    fire_burst_count: Optional[int] = None
    fire_charge_up_ms: Optional[int] = None
    fire_delay_ms: Optional[int] = None
    fire_detect_range: Optional[float] = None
    fire_duration_ms: Optional[int] = None
    fire_refire_ms: Optional[int] = None
    ...
    recoil_first_shot_modifier: Optional[float] = None
    ...
    recoil_shots_at_min_magnitude: Optional[int] = None
