...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, rate_limit=None, sock_read_timeout=None, tls_validation=None, download_concurrency=None, proxy_url=None, name=None, pulp_href=None, url=None, sock_connect_timeout=None, headers=None, pulp_created=None, max_retries=None, total_timeout=None, pulp_last_updated=None, ca_cert=None, pulp_labels=None, client_cert=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
