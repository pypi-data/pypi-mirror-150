...
class AnsibleGitRemote(object):
    ...
    def __init__(self, rate_limit=None, sock_read_timeout=None, tls_validation=None, download_concurrency=None, proxy_url=None, proxy_username=None, name=None, password=None, url=None, sock_connect_timeout=None, headers=None, client_key=None, proxy_password=None, username=None, max_retries=None, total_timeout=None, ca_cert=None, pulp_labels=None, client_cert=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
