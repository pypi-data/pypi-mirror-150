...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, client_key=None, total_timeout=None, proxy_password=None, client_cert=None, sock_read_timeout=None, pulp_labels=None, ca_cert=None, proxy_username=None, proxy_url=None, tls_validation=None, sock_connect_timeout=None, url=None, download_concurrency=None, username=None, connect_timeout=None, password=None, max_retries=None, rate_limit=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
