...
class AnsibleGitRemote(object):
    ...
    def __init__(self, name=None, client_cert=None, sock_read_timeout=None, proxy_username=None, url=None, connect_timeout=None, max_retries=None, username=None, total_timeout=None, rate_limit=None, client_key=None, download_concurrency=None, ca_cert=None, proxy_url=None, password=None, headers=None, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, proxy_password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
