...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, total_timeout=None, client_cert=None, sock_read_timeout=None, pulp_labels=None, ca_cert=None, proxy_url=None, tls_validation=None, pulp_last_updated=None, sock_connect_timeout=None, pulp_created=None, url=None, download_concurrency=None, connect_timeout=None, max_retries=None, rate_limit=None, pulp_href=None, headers=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
