...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, connect_timeout=None, ca_cert=None, client_key=None, proxy_username=None, username=None, rate_limit=None, sock_connect_timeout=None, total_timeout=None, name=None, tls_validation=None, headers=None, download_concurrency=None, sock_read_timeout=None, proxy_url=None, proxy_password=None, password=None, url=None, client_cert=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
