...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, max_retries=None, connect_timeout=None, ca_cert=None, rate_limit=None, sock_connect_timeout=None, total_timeout=None, name=None, pulp_created=None, tls_validation=None, headers=None, download_concurrency=None, sock_read_timeout=None, pulp_href=None, proxy_url=None, url=None, client_cert=None, pulp_labels=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
