...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, client_cert=None, sock_read_timeout=None, url=None, connect_timeout=None, pulp_last_updated=None, max_retries=None, pulp_created=None, total_timeout=None, rate_limit=None, pulp_href=None, download_concurrency=None, ca_cert=None, proxy_url=None, headers=None, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
