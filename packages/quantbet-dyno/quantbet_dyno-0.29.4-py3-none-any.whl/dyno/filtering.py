...
class Options:
    ...
    # If True, shrink the _correlations_ when passing the
    # state covariance into the BFGS inverse hessian estimate.
    ...
    # use `initial_inverse_hessian_scale`
    initial_inverse_hessian_shrinkage: Optional[float] = None
...
def _build_laplace_gaussian_has_observations_true_fn(
    ...
    def has_observations_true():
        ...
        if options.initial_inverse_hessian_scale is not None:
            initial_inverse_hessian_estimate = (
                prior_cov * options.initial_inverse_hessian_scale
            )
        elif options.initial_inverse_hessian_shrinkage is not None:
            shrinkage = options.initial_inverse_hessian_shrinkage
            initial_inverse_hessian_estimate = util.shrink_correlations(
                prior_cov, shrinkage
            )
        else:
