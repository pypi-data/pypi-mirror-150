...
class Ui_PresetPatcherEnergy(object):
    def setupUi(self, PresetPatcherEnergy):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 460, 755))
        ...
        self.immediate_energy_parts_check = QCheckBox(self.energy_tank_box)
        self.immediate_energy_parts_check.setObjectName(u"immediate_energy_parts_check")

        self.gridLayout_2.addWidget(self.immediate_energy_parts_check, 6, 0, 1, 2)
        ...
        self.immediate_energy_parts_label = QLabel(self.energy_tank_box)
        ...
        self.gridLayout_2.addWidget(self.immediate_energy_parts_label, 7, 0, 1, 2)
    ...
    def retranslateUi(self, PresetPatcherEnergy):
        ...
        self.immediate_energy_parts_check.setText(QCoreApplication.translate("PresetPatcherEnergy", u"Immediate Energy Fragments", None))
        ...
        self.immediate_energy_parts_label.setText(QCoreApplication.translate("PresetPatcherEnergy", u"When enabled, Energy Fragments immediately increase your maximum energy by 1/4 of the amount an Energy Tank would.", None))
