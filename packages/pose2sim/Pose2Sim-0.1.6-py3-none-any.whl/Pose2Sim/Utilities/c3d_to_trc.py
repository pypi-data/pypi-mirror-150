...
'''
    ...
    /!\ c3d package currently can't be installed with conda, use 'pip install c3d' instead. 
    Also, it does not work under python >=3.9 (uses the method fromstring, which has been removed from python 3.9).
