...
packages = \
['data_preprocessors',
 'data_preprocessors.count_manager',
 'data_preprocessors.file_manager',
 'data_preprocessors.list_manager',
 'data_preprocessors.punc_manager',
 'data_preprocessors.tokenizers']

package_data = \
{'': ['*']}

install_requires = \
['bnlp-toolkit>=3.1.2,<4.0.0', 'nltk>=3.7,<4.0']
