...
OUTPUT_MODE_DIME = "dime"
OUTPUT_MODE_LOCAL = "local"
OUTPUT_MODE_GLOBAL = "global"
DEFAULT_OUTPUT_MODE = OUTPUT_MODE_DIME
...
# dime explanations
DEFAULT_DIME_EXPLANATION_BASE_KEYS = ['global', 'local', 'dime', 'config', 'timestamp', 'data', 'model']
...
DEFAULT_DIME_EXPLANATION_DIME_KEYS = ['instance', 'local', 'global', 'dual']
