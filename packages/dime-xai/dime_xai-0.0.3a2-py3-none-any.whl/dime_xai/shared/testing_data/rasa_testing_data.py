...
class RASATestingData(TestingData):
    ...
    def _initialize_testing_data(self) -> NoReturn:
        if self._from_rasa:
            self._rasa_testing_data = load_data(resource_name=self.testing_data_dir)
            ...
            if self.case_sensitive:
                testing_data = {k: lowercase_list(v) for k, v in testing_data}
    ...
    def get_intents(self) -> Optional[List]:
        ...
        return list(self._testing_data.keys())
