...
class MammothConnector(object):
    def __init__(self, account_id=None, token=None, api_url=None, api_key=None, api_secret=None):
        """
        ...
        log.info("Logged in to account {0}".format(self.__account_id))
    ...
    def suspend_task(self, view_id, task_id, skip_validation=False, wait_till_ready=True):
        ...
        response = r.json()
        if wait_till_ready:
            future_id = response.get('information').get('future_id')
